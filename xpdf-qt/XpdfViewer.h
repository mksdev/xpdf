...
public:
    ...
    static XpdfViewer *
    create(XpdfApp *app, QString fileName, int page, QString destName, QString password, GBool fullScreen);
    ...
    // success.
    GBool open(QString fileName, int page, QString destName, QString password);

    // Open a file in a new tab.  Returns a boolean indicating success.
    GBool openInNewTab(QString fileName, int page, QString destName, QString password, GBool switchToTab);
