...
#else
#include <math.h>
#if(defined(__GNUC__) && defined(__SSE2__)) || (defined(_WIN32) && (_M_IX86_FP == 2 || defined(_M_X64)))
#include <emmintrin.h>
#endif
#endif
...
static inline int splashFloor(SplashCoord x) {
...
#elif(defined(__GNUC__) && defined(__SSE2__)) || (defined(_WIN32) && (_M_IX86_FP == 2 || defined(_M_X64)))
    ...
    __asm fld QWORD PTR x __asm fnstcw WORD PTR oldCW __asm mov ax, WORD PTR oldCW __asm and ax,
        0xf3ff __asm or ax, 0x0400 __asm mov WORD PTR newCW,
        ax // round down
...
static inline int splashCeil(SplashCoord x) {
    ...
    __asm fld QWORD PTR x __asm fnstcw WORD PTR oldCW __asm mov ax, WORD PTR oldCW __asm and ax,
        0xf3ff __asm or ax, 0x0800 __asm mov WORD PTR newCW,
        ax // round up
        __asm fldcw WORD PTR newCW __asm fistp DWORD PTR result __asm fldcw WORD PTR oldCW return result;
...
static inline GBool
splashCheckDet(SplashCoord m11, SplashCoord m12, SplashCoord m21, SplashCoord m22, SplashCoord epsilon) {
#if USE_FIXEDPOINT
...
static inline void splashStrokeAdjust(SplashCoord xMin,
                                      SplashCoord xMax,
                                      int *xMinI,
                                      int *xMaxI,
