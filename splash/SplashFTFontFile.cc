...
#if LOAD_FONTS_FROM_MEM
    if(FT_New_Memory_Face(engineA->lib, (FT_Byte *)fontBufA->getCString(), fontBufA->getLength(), 0, &faceA)) {
#else
...
#if LOAD_FONTS_FROM_MEM
    if(FT_New_Memory_Face(engineA->lib, (FT_Byte *)fontBufA->getCString(), fontBufA->getLength(),
                          fontNum, &faceA)) {
#else
