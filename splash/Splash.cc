...
struct SplashPipe {
    ...
    // the "run" function
    void (Splash::*run)(SplashPipe *pipe, int x0, int x1, int y, Guchar *shapePtr, SplashColorPtr cSrcPtr);
};

SplashPipeResultColorCtrl Splash::pipeResultColorNoAlphaBlend[] = {splashPipeResultColorNoAlphaBlendMono,
...
SplashPipeResultColorCtrl Splash::pipeResultColorAlphaNoBlend[] = {splashPipeResultColorAlphaNoBlendMono,
...
SplashPipeResultColorCtrl Splash::pipeResultColorAlphaBlend[] = {splashPipeResultColorAlphaBlendMono,
...
inline void Splash::pipeInit(SplashPipe *pipe, SplashPattern *pattern, Guchar aInput, GBool usesShape, GBool nonIsolatedGroup) {
    ...
    // special cases
    pipe->noTransparency = aInput == 255 && !state->softMask && !usesShape &&
                           !state->inNonIsolatedGroup && !state->inKnockoutGroup &&
                           !nonIsolatedGroup && state->overprintMask == 0xffffffff;
    pipe->shapeOnly = aInput == 255 && !state->softMask && usesShape && !state->inNonIsolatedGroup &&
                      !state->inKnockoutGroup && !nonIsolatedGroup && state->overprintMask == 0xffffffff;
    ...
    } else if(!pipe->pattern && !pipe->noTransparency && !state->softMask && usesShape &&
              !(state->inNonIsolatedGroup && groupBackBitmap->alpha) && !state->inKnockoutGroup &&
...
// general case
void Splash::pipeRun(SplashPipe *pipe, int x0, int x1, int y, Guchar *shapePtr, SplashColorPtr cSrcPtr) {
    Guchar *shapePtr2;
    ...
    if(state->inKnockoutGroup) {
        if(bitmap->mode == splashModeMono1) {
            color0Ptr =
                &groupBackBitmap->data[(groupBackY + y) * groupBackBitmap->rowSize + ((groupBackX + x0) >> 3)];
            color0Mask = (Guchar)(0x80 >> ((groupBackX + x0) & 7));
        } else {
            color0Ptr =
                &groupBackBitmap->data[(groupBackY + y) * groupBackBitmap->rowSize + (groupBackX + x0) * bitmapComps];
    ...
    if(state->inNonIsolatedGroup && groupBackBitmap->alpha) {
        alpha0Ptr =
            &groupBackBitmap->alpha[(groupBackY + y) * groupBackBitmap->alphaRowSize + (groupBackX + x0)];
    } else {
        alpha0Ptr = NULL;
    }
            ...
            switch(pipe->resultColorCtrl) {
                ...
                case splashPipeResultColorAlphaNoBlendMono:
                    if(alphaI == 0) {
                        ...
                        cResult0 = (Guchar)(((alphaI - aSrc) * cDest[0] + aSrc * cSrc[0]) / alphaI);
                    }
                    break;
                case splashPipeResultColorAlphaNoBlendRGB:
                    if(alphaI == 0) {
                        ...
                        cResult0 = (Guchar)(((alphaI - aSrc) * cDest[0] + aSrc * cSrc[0]) / alphaI);
                        cResult1 = (Guchar)(((alphaI - aSrc) * cDest[1] + aSrc * cSrc[1]) / alphaI);
                        cResult2 = (Guchar)(((alphaI - aSrc) * cDest[2] + aSrc * cSrc[2]) / alphaI);
                    }
                    break;
#if SPLASH_CMYK
                case splashPipeResultColorAlphaNoBlendCMYK:
                    if(alphaI == 0) {
                        ...
                        cResult1 = (Guchar)(((alphaI - aSrc) * cDest[1] + aSrc * cSrc[1]) / alphaI);
                        cResult2 = (Guchar)(((alphaI - aSrc) * cDest[2] + aSrc * cSrc[2]) / alphaI);
                        cResult3 = (Guchar)(((alphaI - aSrc) * cDest[3] + aSrc * cSrc[3]) / alphaI);
                    }
                    break;
#endif
                ...
                case splashPipeResultColorAlphaBlendMono:
                    if(alphaI == 0) {
                        ...
                        cResult0 = (Guchar)(((alphaI - aSrc) * cDest[0] +
                                             aSrc * ((255 - alphaIm1) * cSrc[0] + alphaIm1 * cBlend[0]) / 255) /
                                            alphaI);
                    }
                    break;
                case splashPipeResultColorAlphaBlendRGB:
                    if(alphaI == 0) {
                        ...
                        cResult1 = (Guchar)(((alphaI - aSrc) * cDest[1] +
                                             aSrc * ((255 - alphaIm1) * cSrc[1] + alphaIm1 * cBlend[1]) / 255) /
                                            alphaI);
                        cResult2 = (Guchar)(((alphaI - aSrc) * cDest[2] +
                                             aSrc * ((255 - alphaIm1) * cSrc[2] + alphaIm1 * cBlend[2]) / 255) /
                                            alphaI);
                    }
                    break;
#if SPLASH_CMYK
                case splashPipeResultColorAlphaBlendCMYK:
                    if(alphaI == 0) {
                        ...
                        cResult3 = (Guchar)(((alphaI - aSrc) * cDest[3] +
                                             aSrc * ((255 - alphaIm1) * cSrc[3] + alphaIm1 * cBlend[3]) / 255) /
                                            alphaI);
                    }
                    break;
#endif
...
void Splash::pipeRunSimpleMono1(SplashPipe *pipe, int x0, int x1, int y, Guchar *shapePtr, SplashColorPtr cSrcPtr) {
    Guchar cResult0;
    SplashColorPtr destColorPtr;
    Guchar destColorMask;
...
void Splash::pipeRunSimpleMono8(SplashPipe *pipe, int x0, int x1, int y, Guchar *shapePtr, SplashColorPtr cSrcPtr) {
    SplashColorPtr destColorPtr;
    Guchar *destAlphaPtr;
    int cSrcStride, x;
...
void Splash::pipeRunSimpleRGB8(SplashPipe *pipe, int x0, int x1, int y, Guchar *shapePtr, SplashColorPtr cSrcPtr) {
    SplashColorPtr destColorPtr;
    Guchar *destAlphaPtr;
    int cSrcStride, x;
...
void Splash::pipeRunSimpleBGR8(SplashPipe *pipe, int x0, int x1, int y, Guchar *shapePtr, SplashColorPtr cSrcPtr) {
    SplashColorPtr destColorPtr;
    Guchar *destAlphaPtr;
    int cSrcStride, x;
...
void Splash::pipeRunSimpleCMYK8(SplashPipe *pipe, int x0, int x1, int y, Guchar *shapePtr, SplashColorPtr cSrcPtr) {
    SplashColorPtr destColorPtr;
    Guchar *destAlphaPtr;
    int cSrcStride, x;
...
// bitmap->mode == splashModeMono1 && !bitmap->alpha
void Splash::pipeRunShapeMono1(SplashPipe *pipe, int x0, int x1, int y, Guchar *shapePtr, SplashColorPtr cSrcPtr) {
...
// !pipe->pattern && pipe->shapeOnly && !state->blendFunc &&
// bitmap->mode == splashModeMono8 && bitmap->alpha
void Splash::pipeRunShapeMono8(SplashPipe *pipe, int x0, int x1, int y, Guchar *shapePtr, SplashColorPtr cSrcPtr) {
...
// !pipe->pattern && pipe->shapeOnly && !state->blendFunc &&
// bitmap->mode == splashModeRGB8 && bitmap->alpha
void Splash::pipeRunShapeRGB8(SplashPipe *pipe, int x0, int x1, int y, Guchar *shapePtr, SplashColorPtr cSrcPtr) {
...
// !pipe->pattern && pipe->shapeOnly && !state->blendFunc &&
// bitmap->mode == splashModeBGR8 && bitmap->alpha
void Splash::pipeRunShapeBGR8(SplashPipe *pipe, int x0, int x1, int y, Guchar *shapePtr, SplashColorPtr cSrcPtr) {
    Guchar shape, aSrc, aDest, alphaI, aResult;
    Guchar cSrc0, cSrc1, cSrc2;
    Guchar cDest0, cDest1, cDest2;
    Guchar cResult0, cResult1, cResult2;
...
// !pipe->pattern && pipe->shapeOnly && !state->blendFunc &&
// bitmap->mode == splashModeCMYK8 && bitmap->alpha
void Splash::pipeRunShapeCMYK8(SplashPipe *pipe, int x0, int x1, int y, Guchar *shapePtr, SplashColorPtr cSrcPtr) {
    Guchar shape, aSrc, aDest, alphaI, aResult;
...
// bitmap->mode == splashModeMono1 && !bitmap->alpha
void Splash::pipeRunAAMono1(SplashPipe *pipe, int x0, int x1, int y, Guchar *shapePtr, SplashColorPtr cSrcPtr) {
    Guchar shape, aSrc, cSrc0, cDest0, cResult0;
    SplashColorPtr destColorPtr;
    Guchar destColorMask;
    SplashScreenCursor screenCursor;
...
// !pipe->nonIsolatedGroup &&
// bitmap->mode == splashModeMono8 && bitmap->alpha
void Splash::pipeRunAAMono8(SplashPipe *pipe, int x0, int x1, int y, Guchar *shapePtr, SplashColorPtr cSrcPtr) {
    Guchar shape, aSrc, aDest, alphaI, aResult, cSrc0, cDest0, cResult0;
    SplashColorPtr destColorPtr;
    Guchar *destAlphaPtr;
    int cSrcStride, x, lastX;
...
// !pipe->nonIsolatedGroup &&
// bitmap->mode == splashModeRGB8 && bitmap->alpha
void Splash::pipeRunAARGB8(SplashPipe *pipe, int x0, int x1, int y, Guchar *shapePtr, SplashColorPtr cSrcPtr) {
    Guchar shape, aSrc, aDest, alphaI, aResult;
    Guchar cSrc0, cSrc1, cSrc2;
    Guchar cDest0, cDest1, cDest2;
    Guchar cResult0, cResult1, cResult2;
...
// !pipe->nonIsolatedGroup &&
// bitmap->mode == splashModeBGR8 && bitmap->alpha
void Splash::pipeRunAABGR8(SplashPipe *pipe, int x0, int x1, int y, Guchar *shapePtr, SplashColorPtr cSrcPtr) {
    Guchar shape, aSrc, aDest, alphaI, aResult;
    Guchar cSrc0, cSrc1, cSrc2;
    Guchar cDest0, cDest1, cDest2;
    Guchar cResult0, cResult1, cResult2;
...
// !pipe->nonIsolatedGroup &&
// bitmap->mode == splashModeCMYK8 && bitmap->alpha
void Splash::pipeRunAACMYK8(SplashPipe *pipe, int x0, int x1, int y, Guchar *shapePtr, SplashColorPtr cSrcPtr) {
    Guchar shape, aSrc, aDest, alphaI, aResult;
    Guchar cSrc0, cSrc1, cSrc2, cSrc3;
    Guchar cDest0, cDest1, cDest2, cDest3;
    Guchar cResult0, cResult1, cResult2, cResult3;
...
void Splash::pipeRunNonIsoMono8(SplashPipe *pipe, int x0, int x1, int y, Guchar *shapePtr, SplashColorPtr cSrcPtr) {
    ...
    destColorPtr = &bitmap->data[y * bitmap->rowSize + x0];
    destAlphaPtr = &bitmap->alpha[y * bitmap->alphaRowSize + x0];
    alpha0Ptr = &groupBackBitmap->alpha[(groupBackY + y) * groupBackBitmap->alphaRowSize + (groupBackX + x0)];
...
void Splash::pipeRunNonIsoRGB8(SplashPipe *pipe, int x0, int x1, int y, Guchar *shapePtr, SplashColorPtr cSrcPtr) {
    Guchar shape, aSrc, aDest, alphaI, alpha0, aResult;
    Guchar cSrc0, cSrc1, cSrc2;
    Guchar cDest0, cDest1, cDest2;
    Guchar cResult0, cResult1, cResult2;
...
void Splash::pipeRunNonIsoBGR8(SplashPipe *pipe, int x0, int x1, int y, Guchar *shapePtr, SplashColorPtr cSrcPtr) {
    Guchar shape, aSrc, aDest, alphaI, alpha0, aResult;
    Guchar cSrc0, cSrc1, cSrc2;
    Guchar cDest0, cDest1, cDest2;
    Guchar cResult0, cResult1, cResult2;
...
#if SPLASH_CMYK
void Splash::pipeRunNonIsoCMYK8(SplashPipe *pipe, int x0, int x1, int y, Guchar *shapePtr, SplashColorPtr cSrcPtr) {
...
inline void
Splash::transform(SplashCoord *matrix, SplashCoord xi, SplashCoord yi, SplashCoord *xo, SplashCoord *yo) {
    //                          [ m[0] m[1] 0 ]
...
Splash::Splash(SplashBitmap *bitmapA, GBool vectorAntialiasA, SplashImageCache *imageCacheA, SplashScreenParams *screenParams) {
    bitmap = bitmapA;
...
Splash::Splash(SplashBitmap *bitmapA, GBool vectorAntialiasA, SplashImageCache *imageCacheA, SplashScreen *screenA) {
    bitmap = bitmapA;
    bitmapComps = splashColorModeNComps[bitmap->mode];
    vectorAntialias = vectorAntialiasA;
    inShading = gFalse;
...
void Splash::setTransfer(Guchar *red, Guchar *green, Guchar *blue, Guchar *gray) {
...
void Splash::clear(SplashColorPtr color, Guchar alpha) {
    ...
    switch(bitmap->mode) {
        case splashModeMono1:
            ...
            if(bitmap->rowSize < 0) {
                memset(bitmap->data + bitmap->rowSize * (bitmap->height - 1), mono,
                       -bitmap->rowSize * bitmap->height);
            } else {
        ...
        case splashModeMono8:
            if(bitmap->rowSize < 0) {
                memset(bitmap->data + bitmap->rowSize * (bitmap->height - 1), color[0],
                       -bitmap->rowSize * bitmap->height);
            } else {
...
SplashError Splash::stroke(SplashPath *path) {
    ...
    if(state->strokeAdjust == splashStrokeAdjustCAD && w2 < 3.5) {
        if(lineCap == splashLineCapRound && !state->lineDashContainsZeroLengthDashes() &&
...
void Splash::strokeNarrow(SplashPath *path) {
    ...
    xPath = new SplashXPath(path, state->matrix, state->flatness, gFalse,
                            state->enablePathSimplification, state->strokeAdjust);

    pipeInit(&pipe, state->strokePattern, (Guchar)splashRound(state->strokeAlpha * 255), gTrue, gFalse);
    ...
    for(i = 0, seg = xPath->segs; i < xPath->length; ++i, ++seg) {
        ...
        if((clipRes = state->clip->testRect(x0 <= x1 ? x0 : x1, y0, x0 <= x1 ? x1 : x0, y1,
                                            state->strokeAdjust)) != splashClipAllOutside) {
            if(y0 == y1) {
                if(x0 <= x1) {
                ...
                if(x0 <= x1) {
                    ...
                    for(y = y0; y <= y1; ++y) {
                        ...
                        if(xa == xb) {
                            ...
                            drawStrokeSpan(&pipe, xa, xb - 1, y, clipRes == splashClipAllInside);
                        }
                        xa = xb;
                    }
                } else {
                    ...
                    for(y = y0; y <= y1; ++y) {
                        ...
                        if(xa == xb) {
                            ...
                            drawStrokeSpan(&pipe, xb + 1, xa, y, clipRes == splashClipAllInside);
                        }
                        xa = xb;
                    }
                }
...
void Splash::drawStrokeSpan(SplashPipe *pipe, int x0, int x1, int y, GBool noClip) {
    int x;
...
void Splash::strokeWide(SplashPath *path, SplashCoord w, int lineCap, int lineJoin) {
    SplashPath *path2;
    ...
    while(i < path->length) {
        ...
        if(flag & splashPathFirst) {
            ...
            if(flag & splashPathCurve) {
                flattenCurve(path->pts[i - 1].x, path->pts[i - 1].y, path->pts[i].x, path->pts[i].y,
                             path->pts[i + 1].x, path->pts[i + 1].y, path->pts[i + 2].x,
                             path->pts[i + 2].y, matrix, flatness2, fPath);
                i += 3;
            } else {
...
void Splash::flattenCurve(SplashCoord x0,
                          SplashCoord y0,
                          SplashCoord x1,
                          SplashCoord y1,
                          SplashCoord x2,
...
SplashPath *Splash::makeDashedPath(SplashPath *path) {
    ...
    while(i < path->length) {
        ...
        if((path->flags[j] & splashPathClosed) && lineDashStartOn && lineDashEndOn) {
            if(nDashes == 1) {
                dPath->close();
            } else if(nDashes > 1) {
                k = subpathStart;
                ...
                ++k;
                memmove(&dPath->pts[subpathStart], &dPath->pts[k], (dPath->length - k) * sizeof(SplashPathPoint));
                memmove(&dPath->flags[subpathStart], &dPath->flags[k], (dPath->length - k) * sizeof(Guchar));
...
SplashError Splash::fillWithPattern(SplashPath *path, GBool eo, SplashPattern *pattern, SplashCoord alpha) {
    SplashPipe pipe;
    SplashPath *path2;
    SplashXPath *xPath;
    ...
    // check clipping
    if((clipRes = state->clip->testRect(xMin, yMin, xMax, yMax, state->strokeAdjust)) != splashClipAllOutside) {
        ...
        pipeInit(&pipe, pattern, (Guchar)splashRound(alpha * 255), gTrue, gFalse);
        ...
        if(vectorAntialias && !inShading) {
            for(y = yMin; y <= yMax; ++y) {
                ...
                if(xMin2 <= xMax2) {
                    if(clipRes != splashClipAllInside) {
                        state->clip->clipSpan(scanBuf, y, xMin2, xMax2, state->strokeAdjust);
                    }
            ...
            for(y = yMin; y <= yMax; ++y) {
                ...
                if(xMin2 <= xMax2) {
                    if(clipRes != splashClipAllInside) {
                        state->clip->clipSpanBinary(scanBuf, y, xMin2, xMax2, state->strokeAdjust);
                    }
                    (this->*pipe.run)(&pipe, xMin2, xMax2, y, scanBuf + xMin2, NULL);
                }
            }
...
SplashPath *Splash::tweakFillPath(SplashPath *path) {
    ...
    n = path->getLength();
    if(!((n == 2) || (n == 3 && path->flags[1] == 0) || (n == 4 && path->flags[1] == 0 && path->flags[2] == 0) ||
         (n == 5 && path->flags[1] == 0 && path->flags[2] == 0 && path->flags[3] == 0))) {
        return path;
    }
    ...
    if(n == 2 || (n == 3 && (path->flags[0] & splashPathClosed)) ||
       ...
       ((n == 4 || (n == 5 && (path->flags[0] & splashPathClosed))) &&
...
GBool Splash::pathAllOutside(SplashPath *path) {
    ...
    return state->clip->testRect(xMinI, yMinI, xMaxI, yMaxI, state->strokeAdjust) == splashClipAllOutside;
}
...
SplashError Splash::fillGlyph(SplashCoord x, SplashCoord y, SplashGlyphBitmap *glyph) {
    SplashCoord xt, yt;
    int x0, y0;
    ...
    if((clipRes = state->clip->testRect(xMin, yMin, xMax, yMax, state->strokeAdjust)) != splashClipAllOutside) {
        ...
        if(clipRes == splashClipAllInside) {
            if(glyph->aa) {
                p = glyph->data;
                for(y = yMin; y <= yMax; ++y) {
                    (this->*pipe.run)(&pipe, xMin, xMax, y, glyph->data + (y - yMin) * glyph->w, NULL);
                }
            } else {
                p = glyph->data;
                for(y = yMin; y <= yMax; ++y) {
            ...
            if(xMin <= xMax && yMin <= yMax) {
                if(glyph->aa) {
                    ...
                    for(y = yMin; y <= yMax; ++y) {
                        p = glyph->data + (y - yg) * ((glyph->w + 7) >> 3) + ((xMin - xg) >> 3);
                        alpha = *p++;
                        xx = (xMin - xg) & 7;
                        ...
                        state->clip->clipSpanBinary(scanBuf, y, xMin, xMax, state->strokeAdjust);
                        (this->*pipe.run)(&pipe, xMin, xMax, y, scanBuf + xMin, NULL);
                    }
                }
            }
...
void Splash::getImageBounds(SplashCoord xyMin, SplashCoord xyMax, int *xyMinI, int *xyMaxI) {
...
SplashError Splash::fillImageMask(GString *imageTag,
    ...
    if(debugMode) {
        printf("fillImageMask: w=%d h=%d mat=[%.2f %.2f %.2f %.2f %.2f %.2f]\n", w, h, (double)mat[0],
               (double)mat[1], (double)mat[2], (double)mat[3], (double)mat[4], (double)mat[5]);
    }
    ...
    if((wSize > 2 * w && hSize > 2 * h && wSize * hSize > 1000000) ||
       ...
       ((wSize > w || hSize > h) && wSize * hSize > 25000000)) {
        ...
        clipRes = state->clip->testRect(x0, y0, x1 - 1, y1 - 1, state->strokeAdjust);
        opClipRes = clipRes;
        if(clipRes != splashClipAllOutside) {
            scaledWidth = x1 - x0;
            scaledHeight = y1 - y0;
            scaledMask = scaleMask(imageTag, src, srcData, w, h, scaledWidth, scaledHeight, interpolate);
        ...
        arbitraryTransformMask(imageTag, src, srcData, w, h, mat, glyphMode, interpolate);
    }
...
// The glyphMode flag is not currently used, but may be useful if the
// stroke adjustment behavior is changed.
void Splash::upscaleMask(SplashImageMaskSource src,
                         void *srcData,
                         int srcWidth,
                         int srcHeight,
                         SplashCoord *mat,
    ...
    // clipping
    clipRes = state->clip->testRect(xMinI, yMinI, xMaxI - 1, yMaxI - 1, state->strokeAdjust);
    opClipRes = clipRes;
    if(clipRes == splashClipAllOutside) {
        return;
    }
    ...
    for(y = yMinI; y < yMaxI; ++y) {
        for(x = xMinI; x < xMaxI; ++x) {
            ...
            if(interpolate) {
                if(ix >= 0 && ix < srcWidth && iy >= 0 && iy < srcHeight) {
                    ...
                    pix0 = ((SplashCoord)1 - sx) * (SplashCoord)unscaledImage[y0 * srcWidth + x0] +
                           sx * (SplashCoord)unscaledImage[y0 * srcWidth + x1];
                    pix1 = ((SplashCoord)1 - sx) * (SplashCoord)unscaledImage[y1 * srcWidth + x0] +
                           sx * (SplashCoord)unscaledImage[y1 * srcWidth + x1];
                    scanBuf[x] = (Guchar)splashRound(((SplashCoord)1 - sy) * pix0 + sy * pix1);
                } else {
                    scanBuf[x] = 0;
                }
            } else {
        ...
        if(clipRes != splashClipAllInside) {
            if(vectorAntialias) {
                state->clip->clipSpan(scanBuf, y, xMinI, xMaxI - 1, state->strokeAdjust);
            } else {
                state->clip->clipSpanBinary(scanBuf, y, xMinI, xMaxI - 1, state->strokeAdjust);
            }
        }
...
void Splash::arbitraryTransformMask(GString *imageTag,
    ...
    clipRes = state->clip->testRect(xMin, yMin, xMax - 1, yMax - 1, state->strokeAdjust);
    opClipRes = clipRes;
    if(clipRes == splashClipAllOutside) {
        return;
    }
    ...
    scaledMask = scaleMask(imageTag, src, srcData, srcWidth, srcHeight, scaledWidth, scaledHeight, interpolate);
    if(imageCache->vertFlip) {
        vertFlipImage(scaledMask, scaledWidth, scaledHeight, 1);
        imageCache->vertFlip = gFalse;
    }
    ...
    for(i = 0; i < nSections; ++i) {
        for(y = section[i].y0; y <= section[i].y1; ++y) {
            xa = splashRound(section[i].xa0 + ((SplashCoord)y + 0.5 - section[i].ya0) * section[i].dxdya);
            xb = splashRound(section[i].xb0 + ((SplashCoord)y + 0.5 - section[i].yb0) * section[i].dxdyb);
            if(xa > xb) {
                continue;
            }
            // make sure narrow images cover at least one pixel
            ...
            if(clipRes != splashClipAllInside) {
                if(vectorAntialias) {
                    ...
                    state->clip->clipSpanBinary(scanBuf, y, xa, xb - 1, state->strokeAdjust);
                }
            }
            // draw the scan line
...
SplashBitmap *Splash::scaleMask(GString *imageTag,
                                ...
                                int scaledHeight,
                                GBool interpolate) {
    if(imageCache->tag && imageTag && !imageCache->tag->cmp(imageTag) && imageCache->isMask &&
       imageCache->width == scaledWidth && imageCache->height == scaledHeight &&
    ...
    imageCache->vertFlip = gFalse;
    imageCache->horizFlip = gFalse;
    imageCache->image = new SplashBitmap(scaledWidth, scaledHeight, 1, splashModeMono8, gFalse, gTrue, NULL);
    if(scaledHeight < srcHeight) {
        if(scaledWidth < srcWidth) {
            scaleMaskYdXd(src, srcData, srcWidth, srcHeight, scaledWidth, scaledHeight, imageCache->image);
        } else {
            scaleMaskYdXu(src, srcData, srcWidth, srcHeight, scaledWidth, scaledHeight, imageCache->image);
        }
    } else {
        if(scaledWidth < srcWidth) {
            scaleMaskYuXd(src, srcData, srcWidth, srcHeight, scaledWidth, scaledHeight, imageCache->image);
        } else {
            if(interpolate) {
                scaleMaskYuXuI(src, srcData, srcWidth, srcHeight, scaledWidth, scaledHeight,
                               imageCache->image);
            } else {
                scaleMaskYuXu(src, srcData, srcWidth, srcHeight, scaledWidth, scaledHeight,
                              imageCache->image);
            }
        }
    }
...
void Splash::scaleMaskYdXd(SplashImageMaskSource src,
                           void *srcData,
                           int srcWidth,
                           int srcHeight,
                           int scaledWidth,
...
void Splash::scaleMaskYdXu(SplashImageMaskSource src,
                           void *srcData,
                           int srcWidth,
                           int srcHeight,
                           int scaledWidth,
...
void Splash::scaleMaskYuXd(SplashImageMaskSource src,
                           void *srcData,
                           int srcWidth,
                           int srcHeight,
                           int scaledWidth,
...
void Splash::scaleMaskYuXu(SplashImageMaskSource src,
                           void *srcData,
                           int srcWidth,
                           int srcHeight,
                           int scaledWidth,
...
void Splash::scaleMaskYuXuI(SplashImageMaskSource src,
                            void *srcData,
                            int srcWidth,
                            int srcHeight,
                            int scaledWidth,
    ...
    for(x = scaledWidth - 1; x >= 0; --x) {
        ...
        lineBuf0[x] =
            (Guchar)(int)((xs * (int)lineBuf0[xSrc0] + ((SplashCoord)1 - xs) * (int)lineBuf0[xSrc1]) * 255);
        lineBuf1[x] =
            (Guchar)(int)((xs * (int)lineBuf1[xSrc0] + ((SplashCoord)1 - xs) * (int)lineBuf1[xSrc1]) * 255);
    }
    ...
    for(y = 0; y < scaledHeight; ++y) {
        ...
        if(ySrc1 > yBuf) {
            ...
            for(x = scaledWidth - 1; x >= 0; --x) {
                ...
                lineBuf1[x] = (Guchar)(
                    int)((xs * (int)lineBuf1[xSrc0] + ((SplashCoord)1 - xs) * (int)lineBuf1[xSrc1]) * 255);
            }
        ...
        for(x = 0; x < scaledWidth; ++x) {
            ...
            pix = (Guchar)(int)(ys * (int)lineBuf0[x] + ((SplashCoord)1 - ys) * (int)lineBuf1[x]);
...
void Splash::blitMask(SplashBitmap *src, int xDest, int yDest, SplashClipResult clipRes) {
    ...
    if(clipRes == splashClipAllInside) {
        for(y = 0; y < h; ++y) {
            (this->*pipe.run)(&pipe, xDest, xDest + w - 1, yDest + y, src->data + y * (size_t)w, NULL);
        }
    } else {
        x0 = xDest;
        ...
        if(x0 < x1 && y0 < y1) {
            for(y = y0; y < y1; ++y) {
                memcpy(scanBuf + x0, src->data + (y - yDest) * (size_t)w + (x0 - xDest), x1 - x0);
                if(vectorAntialias) {
                    state->clip->clipSpan(scanBuf, y, x0, x1 - 1, state->strokeAdjust);
                } else {
                    state->clip->clipSpanBinary(scanBuf, y, x0, x1 - 1, state->strokeAdjust);
                }
...
SplashError Splash::drawImage(GString *imageTag,
    ...
    if((wSize > 2 * w && hSize > 2 * h && wSize * hSize > 1000000) ||
       ...
       ((wSize > w || hSize > h) && wSize * hSize > 25000000)) {
#endif
        upscaleImage(src, srcData, srcMode, nComps, srcAlpha, w, h, mat, interpolate);
        ...
        if(clipRes != splashClipAllOutside) {
            scaledWidth = x1 - x0;
            scaledHeight = y1 - y0;
            scaledImg = scaleImage(imageTag, src, srcData, srcMode, nComps, srcAlpha, w, h,
        ...
        arbitraryTransformImage(imageTag, src, srcData, srcMode, nComps, srcAlpha, w, h, mat, interpolate);
    }

    return splashOk;
}

void Splash::upscaleImage(SplashImageSource src,
                          void *srcData,
                          SplashColorMode srcMode,
                          int nComps,
                          GBool srcAlpha,
    ...
    pipeInit(&pipe, NULL, (Guchar)splashRound(state->fillAlpha * 255), gTrue, gFalse);
    for(y = yMinI; y < yMaxI; ++y) {
        p = pixelBuf;
        for(x = xMinI; x < xMaxI; ++x) {
            ix = ((SplashCoord)x + 0.5) * mi0 + ((SplashCoord)y + 0.5) * mi2 + mi4;
            ...
            if(interpolate) {
                if(ix >= 0 && ix < srcWidth && iy >= 0 && iy < srcHeight) {
                    ...
                    for(i = 0; i < nComps; ++i) {
                        ...
                        *p++ = (Guchar)splashRound(((SplashCoord)1 - sy) * pix0 + sy * pix1);
                    }
                    if(srcAlpha) {
                        pix0 = ((SplashCoord)1 - sx) * (SplashCoord)unscaledAlpha[y0 * srcWidth + x0] +
                               sx * (SplashCoord)unscaledAlpha[y0 * srcWidth + x1];
                        pix1 = ((SplashCoord)1 - sx) * (SplashCoord)unscaledAlpha[y1 * srcWidth + x0] +
...
void Splash::arbitraryTransformImage(GString *imageTag,
    ...
    // scale the input image
    scaledImg = scaleImage(imageTag, src, srcData, srcMode, nComps, srcAlpha, srcWidth, srcHeight,
                           scaledWidth, scaledHeight, interpolate);
    if(imageCache->vertFlip) {
        vertFlipImage(scaledImg, scaledWidth, scaledHeight, nComps);
        imageCache->vertFlip = gFalse;
    ...
    for(i = 0; i < nSections; ++i) {
        for(y = section[i].y0; y <= section[i].y1; ++y) {
            ...
            for(x = xa; x < xb; ++x) {
                ...
                // apply alpha
                if(srcAlpha) {
                    scanBuf[x] = div255(scanBuf[x] * scaledImg->alpha[yy * scaledWidth + xx]);
                }
            }
...
SplashBitmap *Splash::scaleImage(GString *imageTag,
                                 ...
                                 GBool interpolate) {
    if(imageCache->tag && imageTag && !imageCache->tag->cmp(imageTag) && !imageCache->isMask &&
       imageCache->width == scaledWidth && imageCache->height == scaledHeight && imageCache->mode == srcMode &&
       imageCache->alpha == srcAlpha && imageCache->interpolate == interpolate) {
        return imageCache->image;
    }
    if(imageCache->tag) {
        delete imageCache->tag;
    ...
    imageCache->vertFlip = gFalse;
    imageCache->horizFlip = gFalse;
    imageCache->image = new SplashBitmap(scaledWidth, scaledHeight, 1, srcMode, srcAlpha, gTrue, NULL);
    if(scaledHeight < srcHeight) {
        if(scaledWidth < srcWidth) {
            scaleImageYdXd(src, srcData, srcMode, nComps, srcAlpha, srcWidth, srcHeight,
                           scaledWidth, scaledHeight, imageCache->image);
        } else {
            scaleImageYdXu(src, srcData, srcMode, nComps, srcAlpha, srcWidth, srcHeight,
                           scaledWidth, scaledHeight, imageCache->image);
        }
    } else {
        if(scaledWidth < srcWidth) {
            scaleImageYuXd(src, srcData, srcMode, nComps, srcAlpha, srcWidth, srcHeight,
                           scaledWidth, scaledHeight, imageCache->image);
        } else {
            if(interpolate) {
                scaleImageYuXuI(src, srcData, srcMode, nComps, srcAlpha, srcWidth, srcHeight,
                                scaledWidth, scaledHeight, imageCache->image);
            } else {
                scaleImageYuXu(src, srcData, srcMode, nComps, srcAlpha, srcWidth, srcHeight,
                               scaledWidth, scaledHeight, imageCache->image);
            }
        }
    }
...
void Splash::scaleImageYdXd(SplashImageSource src,
                            void *srcData,
                            SplashColorMode srcMode,
                            int nComps,
                            GBool srcAlpha,
...
void Splash::scaleImageYdXu(SplashImageSource src,
                            void *srcData,
                            SplashColorMode srcMode,
                            int nComps,
                            GBool srcAlpha,
...
void Splash::scaleImageYuXd(SplashImageSource src,
                            void *srcData,
                            SplashColorMode srcMode,
                            int nComps,
                            GBool srcAlpha,
...
void Splash::scaleImageYuXu(SplashImageSource src,
                            void *srcData,
                            SplashColorMode srcMode,
                            int nComps,
                            GBool srcAlpha,
    ...
    for(y = 0; y < srcHeight; ++y) {
        ...
        // duplicate the row vertically
        for(i = 1; i < yStep; ++i) {
            memcpy(destPtr, destPtr - scaledWidth * nComps, scaledWidth * nComps);
...
void Splash::scaleImageYuXuI(SplashImageSource src,
                             void *srcData,
                             SplashColorMode srcMode,
                             int nComps,
                             GBool srcAlpha,
    ...
    for(x = scaledWidth - 1; x >= 0; --x) {
        ...
        for(i = 0; i < nComps; ++i) {
            lineBuf0[x * nComps + i] =
                (Guchar)(int)(xs * (int)lineBuf0[xSrc0 * nComps + i] +
                              ((SplashCoord)1 - xs) * (int)lineBuf0[xSrc1 * nComps + i]);
            lineBuf1[x * nComps + i] =
                (Guchar)(int)(xs * (int)lineBuf1[xSrc0 * nComps + i] +
                              ((SplashCoord)1 - xs) * (int)lineBuf1[xSrc1 * nComps + i]);
        }
        if(srcAlpha) {
            alphaLineBuf0[x] = (Guchar)(int)(xs * (int)alphaLineBuf0[xSrc0] +
                                             ((SplashCoord)1 - xs) * (int)alphaLineBuf0[xSrc1]);
            alphaLineBuf1[x] = (Guchar)(int)(xs * (int)alphaLineBuf1[xSrc0] +
    ...
    for(y = 0; y < scaledHeight; ++y) {
        ...
        for(x = 0; x < scaledWidth; ++x) {
            ...
            for(i = 0; i < nComps; ++i) {
                pix[i] = (Guchar)(int)(ys * (int)lineBuf0[x * nComps + i] +
            ...
            // process alpha
            if(srcAlpha) {
                *destAlphaPtr++ = (Guchar)(int)(ys * (int)alphaLineBuf0[x] +
...
void Splash::vertFlipImage(SplashBitmap *img, int width, int height, int nComps) {
    ...
    for(p0 = img->data, p1 = img->data + (height - 1) * (size_t)w; p0 < p1; p0 += w, p1 -= w) {
        memcpy(lineBuf, p0, w);
        memcpy(p0, p1, w);
        memcpy(p1, lineBuf, w);
    }
    if(img->alpha) {
        for(p0 = img->alpha, p1 = img->alpha + (height - 1) * (size_t)width; p0 < p1; p0 += width, p1 -= width) {
...
void Splash::horizFlipImage(SplashBitmap *img, int width, int height, int nComps) {
    Guchar *lineBuf;
...
void Splash::blitImage(SplashBitmap *src, GBool srcAlpha, int xDest, int yDest, SplashClipResult clipRes) {
    SplashPipe pipe;
    ...
    if(x0 < w && y0 < h && x0 < x1 && y0 < y1) {
        pipeInit(&pipe, NULL, (Guchar)splashRound(state->fillAlpha * 255), srcAlpha, gFalse);
        if(srcAlpha) {
            for(y = y0; y < y1; ++y) {
            ...
            for(y = y0; y < y1; ++y) {
                (this->*pipe.run)(&pipe, xDest + x0, xDest + x1 - 1, yDest + y, NULL,
                                  src->data + y * src->getRowSize() + x0 * bitmapComps);
            }
        }
    }
...
void Splash::blitImageClipped(SplashBitmap *src, GBool srcAlpha, int xSrc, int ySrc, int xDest, int yDest, int w, int h) {
    SplashPipe pipe;
    int y;
    ...
    if(srcAlpha) {
        for(y = 0; y < h; ++y) {
            memcpy(scanBuf + xDest, src->alpha + (ySrc + y) * src->alphaRowSize + xSrc, w);
            if(vectorAntialias) {
                state->clip->clipSpan(scanBuf, yDest + y, xDest, xDest + w - 1, state->strokeAdjust);
            } else {
                state->clip->clipSpanBinary(scanBuf, yDest + y, xDest, xDest + w - 1, state->strokeAdjust);
            }
            (this->*pipe.run)(&pipe, xDest, xDest + w - 1, yDest + y, scanBuf + xDest,
                              src->data + (ySrc + y) * src->rowSize + xSrc * bitmapComps);
        }
    } else {
        for(y = 0; y < h; ++y) {
...
SplashError
Splash::composite(SplashBitmap *src, int xSrc, int ySrc, int xDest, int yDest, int w, int h, GBool noClip, GBool nonIsolated) {
    SplashPipe pipe;
    Guchar *mono1Ptr, *lineBuf, *linePtr;
    Guchar mono1Mask, b;
    int x0, x1, x, y0, y1, y, t;

    if(!(src->mode == bitmap->mode || (src->mode == splashModeMono8 && bitmap->mode == splashModeMono1) ||
         (src->mode == splashModeRGB8 && bitmap->mode == splashModeBGR8))) {
        return splashErrModeMismatch;
    }

    pipeInit(&pipe, NULL, (Guchar)splashRound(state->fillAlpha * 255), !noClip || src->alpha != NULL, nonIsolated);
    if(src->mode == splashModeMono1) {
        ...
        if(noClip) {
            if(src->alpha) {
                for(y = 0; y < h; ++y) {
                    ...
                    (this->*pipe.run)(&pipe, xDest, xDest + w - 1, yDest + y,
                                      src->alpha + (ySrc + y) * src->alphaRowSize + xSrc, scanBuf);
                }
            } else {
                for(y = 0; y < h; ++y) {
                    mono1Ptr = src->data + (ySrc + y) * src->rowSize + (xSrc >> 3);
                    ...
                    (this->*pipe.run)(&pipe, xDest, xDest + w - 1, yDest + y, NULL, scanBuf);
                }
            }
        } else {
            x0 = xDest;
            ...
            if(x0 < x1 && y0 < y1) {
                if(src->alpha) {
                    for(y = y0; y < y1; ++y) {
                        mono1Ptr = src->data + (ySrc + y - yDest) * src->rowSize + ((xSrc + x0 - xDest) >> 3);
                        ...
                        memcpy(scanBuf2 + x0,
                               src->alpha + (ySrc + y - yDest) * src->alphaRowSize + (xSrc + x0 - xDest),
                               x1 - x0);
                        if(!state->clip->clipSpanBinary(scanBuf2, y, x0, x1 - 1, state->strokeAdjust)) {
                            continue;
                        }
                        // this uses shape instead of alpha, which isn't technically
                        // correct, but works out the same
                        (this->*pipe.run)(&pipe, x0, x1 - 1, y, scanBuf2 + x0, scanBuf + x0);
                    }
                } else {
                    for(y = y0; y < y1; ++y) {
                        mono1Ptr = src->data + (ySrc + y - yDest) * src->rowSize + ((xSrc + x0 - xDest) >> 3);
        ...
        if(noClip) {
            if(src->alpha) {
                for(y = 0; y < h; ++y) {
                    memcpy(lineBuf, src->data + (ySrc + y) * src->rowSize + xSrc * 3, w * 3);
                    ...
                    // correct, but works out the same
                    (this->*pipe.run)(&pipe, xDest, xDest + w - 1, yDest + y,
                                      src->alpha + (ySrc + y) * src->alphaRowSize + xSrc, lineBuf);
                }
            } else {
                for(y = 0; y < h; ++y) {
                    memcpy(lineBuf, src->data + (ySrc + y) * src->rowSize + xSrc * 3, w * 3);
                    ...
                    (this->*pipe.run)(&pipe, xDest, xDest + w - 1, yDest + y, NULL, lineBuf);
                }
            }
        } else {
            x0 = xDest;
                ...
                if(src->alpha) {
                    for(y = y0; y < y1; ++y) {
                        memcpy(scanBuf + x0,
                               ...
                               x1 - x0);
                        state->clip->clipSpan(scanBuf, y, x0, x1 - 1, state->strokeAdjust);
                        memcpy(lineBuf, src->data + (ySrc + y - yDest) * src->rowSize + (xSrc + x0 - xDest) * 3,
                               (x1 - x0) * 3);
                        ...
                        // this uses shape instead of alpha, which isn't technically
                        // correct, but works out the same
                        (this->*pipe.run)(&pipe, x0, x1 - 1, y, scanBuf + x0, lineBuf);
                    }
                } else {
                    for(y = y0; y < y1; ++y) {
                        ...
                        (this->*pipe.run)(&pipe, x0, x1 - 1, yDest + y, scanBuf + x0,
                                          src->data + (ySrc + y - yDest) * src->rowSize +
        ...
        if(noClip) {
            if(src->alpha) {
                ...
                for(y = 0; y < h; ++y) {
                    (this->*pipe.run)(&pipe, xDest, xDest + w - 1, yDest + y, NULL,
                                      src->data + (ySrc + y) * src->rowSize + xSrc * bitmapComps);
                }
            }
        } else {
            ...
            if(x0 < x1 && y0 < y1) {
                if(src->alpha) {
                    for(y = y0; y < y1; ++y) {
                        ...
                        // this uses shape instead of alpha, which isn't technically
                        // correct, but works out the same
                        (this->*pipe.run)(&pipe, x0, x1 - 1, y, scanBuf + x0,
                                          src->data + (ySrc + y - yDest) * src->rowSize +
                                              (xSrc + x0 - xDest) * bitmapComps);
                    }
                } else {
...
SplashError
Splash::blitCorrectedAlpha(SplashBitmap *dest, int xSrc, int ySrc, int xDest, int yDest, int w, int h) {
    SplashColorPtr p, q;
    Guchar *alpha0Ptr;
    ...
    for(y = 0; y < h; ++y) {
        ...
        alpha0Ptr =
            &groupBackBitmap->alpha[(groupBackY + ySrc + y) * groupBackBitmap->alphaRowSize + (groupBackX + xSrc)];
        for(x = 0; x < w; ++x) {
            alpha0 = *alpha0Ptr++;
            aSrc = *q++;
...
SplashPath *Splash::makeStrokePath(SplashPath *path, SplashCoord w, int lineCap, int lineJoin, GBool flatten) {
    ...
    i0 = 0;
    for(i1 = i0;
        !(pathIn->flags[i1] & splashPathLast) && i1 + 1 < pathIn->length &&
        pathIn->pts[i1 + 1].x == pathIn->pts[i1].x && pathIn->pts[i1 + 1].y == pathIn->pts[i1].y;
        ++i1)
        ;
    ...
    while(i1 < pathIn->length) {
        ...
        j0 = i1 + 1;
        if(j0 < pathIn->length) {
            for(j1 = j0; !(pathIn->flags[j1] & splashPathLast) && j1 + 1 < pathIn->length &&
        ...
        if(pathIn->flags[i1] & splashPathLast) {
            if(first && lineCap == splashLineCapRound) {
                ...
                pathOut->curveTo(pathIn->pts[i0].x + (SplashCoord)0.5 * w,
                                 pathIn->pts[i0].y + bezierCircle2 * w, pathIn->pts[i0].x + bezierCircle2 * w,
                                 pathIn->pts[i0].y + (SplashCoord)0.5 * w, pathIn->pts[i0].x,
                ...
                pathOut->curveTo(pathIn->pts[i0].x - bezierCircle2 * w,
                                 ...
                                 pathIn->pts[i0].x - (SplashCoord)0.5 * w, pathIn->pts[i0].y);
                pathOut->curveTo(pathIn->pts[i0].x - (SplashCoord)0.5 * w,
                                 pathIn->pts[i0].y - bezierCircle2 * w, pathIn->pts[i0].x - bezierCircle2 * w,
                                 pathIn->pts[i0].y - (SplashCoord)0.5 * w, pathIn->pts[i0].x,
                                 pathIn->pts[i0].y - (SplashCoord)0.5 * w);
        ...
        for(k1 = k0;
            !(pathIn->flags[k1] & splashPathLast) && k1 + 1 < pathIn->length &&
            pathIn->pts[k1 + 1].x == pathIn->pts[k1].x && pathIn->pts[k1 + 1].y == pathIn->pts[k1].y;
            ++k1)
            ;
        ...
        d = splashDist(pathIn->pts[i1].x, pathIn->pts[i1].y, pathIn->pts[j0].x, pathIn->pts[j0].y);
        dx = (pathIn->pts[j0].x - pathIn->pts[i1].x) / d;
        dy = (pathIn->pts[j0].y - pathIn->pts[i1].y) / d;
#else
        d = (SplashCoord)1 /
            splashDist(pathIn->pts[i1].x, pathIn->pts[i1].y, pathIn->pts[j0].x, pathIn->pts[j0].y);
        ...
        if(first && !closed) {
            switch(lineCap) {
                ...
                case splashLineCapProjecting:
                    pathOut->moveTo(pathIn->pts[i0].x - wdx - wdy, pathIn->pts[i0].y + wdx - wdy);
        ...
        if(!last || closed) {
            ...
            // the 1/d value can be small, which introduces significant
            // inaccuracies in fixed point mode
            d = splashDist(pathIn->pts[j1].x, pathIn->pts[j1].y, pathIn->pts[k0].x, pathIn->pts[k0].y);
            dxNext = (pathIn->pts[k0].x - pathIn->pts[j1].x) / d;
            dyNext = (pathIn->pts[k0].y - pathIn->pts[j1].y) / d;
#else
            d = (SplashCoord)1 /
                splashDist(pathIn->pts[j1].x, pathIn->pts[j1].y, pathIn->pts[k0].x, pathIn->pts[k0].y);
            ...
            if(lineJoin == splashLineJoinRound) {
                ...
                if(crossprod < 0) {
                    ...
                    if(dAngle < 0.501) {
                        ...
                        pathOut->curveTo(cx2, cy2, cx1, cy1, pathIn->pts[j0].x - wdy,
                                         pathIn->pts[j0].y + wdx);
                    } else {
                        ...
                        if(dJoin > 0) {
                            ...
                            xc = pathIn->pts[j0].x +
                                 (SplashCoord)0.5 * w * cos((double)((SplashCoord)0.5 * (angle + angleNext)));
                            yc = pathIn->pts[j0].y +
                                 (SplashCoord)0.5 * w * sin((double)((SplashCoord)0.5 * (angle + angleNext)));
                    ...
                    if(dAngle < 0.501) {
                        ...
                        pathOut->moveTo(pathIn->pts[j0].x, pathIn->pts[j0].y);
                        pathOut->lineTo(pathIn->pts[j0].x + wdy, pathIn->pts[j0].y - wdx);
                        pathOut->curveTo(cx1, cy1, cx2, cy2, pathIn->pts[j0].x + wdyNext,
                        ...
                        if(dJoin > 0) {
                            ...
                            pathOut->curveTo(cx3, cy3, cx4, cy4, pathIn->pts[j0].x + wdyNext,
                                             pathIn->pts[j0].y - wdxNext);
                        }
                    }
                }
                ...
                if(crossprod < 0) {
                    ...
                    if(lineJoin == splashLineJoinMiter && splashSqrt(miter) <= state->miterLimit) {
        ...
        if(state->strokeAdjust != splashStrokeAdjustOff) {
            ...
            if(seg == 0 && last) {
                switch(lineCap) {
                    case splashLineCapButt:
                        pathOut->addStrokeAdjustHint(firstPt, left2 + 1, firstPt, pathOut->length - 1);
                        break;
                    case splashLineCapProjecting:
                        pathOut->addStrokeAdjustHint(firstPt, left2 + 1, firstPt, pathOut->length - 1, gTrue);
                        break;
                    case splashLineCapRound:
                        break;
                }
                pathOut->addStrokeAdjustHint(left2, right2, firstPt, pathOut->length - 1);
            } else {
                ...
                if(seg == 1) {
                    ...
                    if(!closed) {
                        switch(lineCap) {
                            case splashLineCapButt:
                                pathOut->addStrokeAdjustHint(firstPt, left1 + 1, firstPt, firstPt + 1);
                                pathOut->addStrokeAdjustHint(firstPt, left1 + 1, right1 + 1, right1 + 1);
                                break;
                            case splashLineCapProjecting:
                                pathOut->addStrokeAdjustHint(firstPt, left1 + 1, firstPt, firstPt + 1, gTrue);
                                pathOut->addStrokeAdjustHint(firstPt, left1 + 1, right1 + 1, right1 + 1, gTrue);
                                break;
                            case splashLineCapRound:
                                break;
                        }
                ...
                if(last) {
                    ...
                    if(closed) {
                        // first segment
                        pathOut->addStrokeAdjustHint(leftFirst, rightFirst, left2 + 1, right2);
                        pathOut->addStrokeAdjustHint(leftFirst, rightFirst, join2, pathOut->length - 1);

                        // last segment
                        pathOut->addStrokeAdjustHint(left2, right2, left1 + 1, right1);
                        pathOut->addStrokeAdjustHint(left2, right2, join1, pathOut->length - 1);
                        pathOut->addStrokeAdjustHint(left2, right2, leftFirst - 1, leftFirst);
                        pathOut->addStrokeAdjustHint(left2, right2, rightFirst + 1, rightFirst + 1);
                        ...
                        switch(lineCap) {
                            case splashLineCapButt:
                                pathOut->addStrokeAdjustHint(left2 - 1, left2 + 1, left2 + 1, left2 + 2);
                                break;
                            case splashLineCapProjecting:
                                pathOut->addStrokeAdjustHint(left2 - 1, left2 + 1, left2 + 1, left2 + 2, gTrue);
                                break;
                            case splashLineCapRound:
                                break;
                        }
...
SplashClipResult Splash::limitRectToClipRect(int *xMin, int *yMin, int *xMax, int *yMax) {
    int t;
    ...
    return state->clip->testRect(*xMin, *yMin, *xMax - 1, *yMax - 1, state->strokeAdjust);
}
...
void Splash::dumpPath(SplashPath *path) {
    ...
    for(i = 0; i < path->length; ++i) {
        printf("  %3d: x=%8.2f y=%8.2f%s%s%s%s\n", i, (double)path->pts[i].x,
               (double)path->pts[i].y, (path->flags[i] & splashPathFirst) ? " first" : "",
    ...
    if(path->hintsLength == 0) {
        ...
        for(i = 0; i < path->hintsLength; ++i) {
            printf("  hint %3d: ctrl0=%d ctrl1=%d pts=%d..%d\n", i, path->hints[i].ctrl0,
                   path->hints[i].ctrl1, path->hints[i].firstPt, path->hints[i].lastPt);
        }
    }
}
...
void Splash::dumpXPath(SplashXPath *path) {
    ...
    for(i = 0; i < path->length; ++i) {
        printf("  %4d: x0=%8.2f y0=%8.2f x1=%8.2f y1=%8.2f count=%d\n", i, (double)path->segs[i].x0,
               (double)path->segs[i].y0, (double)path->segs[i].x1, (double)path->segs[i].y1,
               path->segs[i].count);
    }
}
