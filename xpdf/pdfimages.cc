...
static ArgDesc argDesc[] = {
    ...
    {"-raw", argFlag, &dumpRaw, 0, "write raw data in PDF-native formats"},
    {"-list", argFlag, &list, 0, "write information to stdout for each image"},
...
int main(int argc, char *argv[]) {
    ...
    if(imgOut->isOk()) {
        doc->displayPages(imgOut, firstPage, lastPage, 72, 72, 0, gFalse, gTrue, gFalse);
    }
    delete imgOut;
