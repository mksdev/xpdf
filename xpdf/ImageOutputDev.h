...
public:
    ...
    ImageOutputDev(char *fileRootA, GBool dumpJPEGA, GBool dumpRawA, GBool listA);
...
private:
    ...
    void writeImageInfo(int width, int height, GfxState *state, GfxImageColorMap *colorMap);
