...
enum SysFontType { sysFontPFA, sysFontPFB, sysFontTTF, sysFontTTC, sysFontOTF };
...
enum StrokeAdjustMode { strokeAdjustOff, strokeAdjustNormal, strokeAdjustCAD };
...
private:
    ...
    GBool parseKey(GString *modKeyStr,
                   GString *contextStr,
                   int *code,
                   int *mods,
                   int *context,
