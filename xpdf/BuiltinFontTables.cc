...
static BuiltinFontWidth courierWidthsTab[] = {{"odieresis", 600, NULL},
                                              {"M", 600, NULL},
                                              {"Ograve", 600, NULL},
                                              {"T", 600, NULL},
                                              {"amacron", 600, NULL},
...
static BuiltinFontWidth courierBoldWidthsTab[] = {{"t", 600, NULL},
                                                  {"quotedbl", 600, NULL},
                                                  {"Oacute", 600, NULL},
                                                  {"agrave", 600, NULL},
                                                  {"ellipsis", 600, NULL},
...
static BuiltinFontWidth courierBoldObliqueWidthsTab[] = {{"greater", 600, NULL},
                                                         {"asterisk", 600, NULL},
                                                         {"Emacron", 600, NULL},
                                                         {"scommaaccent", 600, NULL},
                                                         {"onesuperior", 600, NULL},
...
static BuiltinFontWidth courierObliqueWidthsTab[] = {{"ecaron", 600, NULL},
                                                     {"brokenbar", 600, NULL},
                                                     {"Aogonek", 600, NULL},
                                                     {"w", 600, NULL},
                                                     {"Thorn", 600, NULL},
...
static BuiltinFontWidth helveticaWidthsTab[] = {{"lcommaaccent", 222, NULL},
                                                {"onehalf", 834, NULL},
...
static BuiltinFontWidth helveticaBoldWidthsTab[] = {{"uogonek", 611, NULL},
                                                    {"quoteright", 278, NULL},
                                                    {"guilsinglright", 333, NULL},
                                                    {"semicolon", 333, NULL},
                                                    {"V", 667, NULL},
...
static BuiltinFontWidth helveticaBoldObliqueWidthsTab[] = {{"divide", 584, NULL},
                                                           {"emacron", 556, NULL},
                                                           {"numbersign", 556, NULL},
                                                           {"Ncommaaccent", 722, NULL},
                                                           {"amacron", 556, NULL},
...
static BuiltinFontWidth helveticaObliqueWidthsTab[] = {{"dieresis", 333, NULL},
                                                       {"Eacute", 667, NULL},
                                                       {"Icircumflex", 278, NULL},
                                                       {"O", 778, NULL},
                                                       {"nacute", 556, NULL},
...
static BuiltinFontWidth symbolWidthsTab[] = {{"copyrightsans", 790, NULL},
                                             {"Upsilon", 690, NULL},
                                             {"sigma", 603, NULL},
                                             {"kappa", 549, NULL},
                                             {"circleplus", 768, NULL},
...
static BuiltinFontWidth timesBoldWidthsTab[] = {{"cacute", 444, NULL},
                                                {"Dcroat", 722, NULL},
                                                {"tcaron", 416, NULL},
                                                {"rcaron", 444, NULL},
                                                {"ncommaaccent", 556, NULL},
...
static BuiltinFontWidth timesBoldItalicWidthsTab[] = {{"M", 889, NULL},
                                                      {"odieresis", 500, NULL},
                                                      {"Ograve", 722, NULL},
                                                      {"T", 611, NULL},
                                                      {"amacron", 500, NULL},
...
static BuiltinFontWidth timesItalicWidthsTab[] = {{"quoteright", 333, NULL},
                                                  {"uogonek", 500, NULL},
                                                  {"semicolon", 333, NULL},
                                                  {"guilsinglright", 333, NULL},
                                                  {"Umacron", 722, NULL},
...
static BuiltinFontWidth timesRomanWidthsTab[] = {{"greaterequal", 549, NULL},
                                                 {"at", 921, NULL},
                                                 {"sterling", 500, NULL},
                                                 {"H", 722, NULL},
                                                 {"caron", 333, NULL},
...
static BuiltinFontWidth zapfDingbatsWidthsTab[] = {
    {"a198", 888, NULL},  {"a107", 760, NULL}, {"a167", 927, NULL}, {"a97", 392, NULL},
    {"a137", 788, NULL},  {"a175", 930, NULL}, {"a55", 708, NULL},  {"a206", 410, NULL},
    {"a146", 788, NULL},  {"a27", 759, NULL},  {"a71", 791, NULL},  {"a79", 784, NULL},
    {"a136", 788, NULL},  {"a43", 923, NULL},  {"a131", 788, NULL}, {"a154", 788, NULL},
    {"a123", 788, NULL},  {"a8", 537, NULL},   {"a87", 234, NULL},  {"a72", 873, NULL},
    {"a199", 867, NULL},  {"a151", 788, NULL}, {"a99", 668, NULL},  {"a126", 788, NULL},
    {"a46", 749, NULL},   {"a34", 794, NULL},  {"a186", 967, NULL}, {"a102", 544, NULL},
    {"a205", 509, NULL},  {"a62", 707, NULL},  {"a140", 788, NULL}, {"a90", 390, NULL},
    {"a98", 392, NULL},   {"a9", 577, NULL},   {"a178", 883, NULL}, {"a26", 760, NULL},
    {"a40", 833, NULL},   {"a125", 788, NULL}, {"a101", 732, NULL}, {"a103", 544, NULL},
    {"a150", 788, NULL},  {"a57", 701, NULL},  {"a18", 974, NULL},  {"a184", 946, NULL},
    {"space", 278, NULL}, {"a74", 762, NULL},  {"a168", 928, NULL}, {"a147", 788, NULL},
    {"a187", 831, NULL},  {"a110", 694, NULL}, {"a143", 788, NULL}, {"a36", 823, NULL},
    {"a41", 816, NULL},   {"a86", 410, NULL},  {"a164", 458, NULL}, {"a152", 788, NULL},
    {"a163", 1016, NULL}, {"a3", 980, NULL},   {"a160", 894, NULL}, {"a166", 918, NULL},
    {"a117", 690, NULL},  {"a83", 277, NULL},  {"a29", 786, NULL},  {"a22", 761, NULL},
    {"a112", 776, NULL},  {"a133", 788, NULL}, {"a156", 788, NULL}, {"a200", 696, NULL},
    {"a81", 438, NULL},   {"a106", 667, NULL}, {"a100", 668, NULL}, {"a132", 788, NULL},
    {"a95", 334, NULL},   {"a37", 789, NULL},  {"a58", 826, NULL},  {"a191", 918, NULL},
    {"a56", 682, NULL},   {"a70", 785, NULL},  {"a157", 788, NULL}, {"a171", 873, NULL},
    {"a188", 873, NULL},  {"a47", 790, NULL},  {"a14", 855, NULL},  {"a23", 571, NULL},
    {"a2", 961, NULL},    {"a77", 892, NULL},  {"a105", 911, NULL}, {"a25", 763, NULL},
    {"a202", 974, NULL},  {"a61", 789, NULL},  {"a10", 692, NULL},  {"a44", 744, NULL},
    {"a159", 788, NULL},  {"a48", 792, NULL},  {"a124", 788, NULL}, {"a190", 970, NULL},
    {"a20", 846, NULL},   {"a185", 865, NULL}, {"a16", 933, NULL},  {"a11", 960, NULL},
    {"a134", 788, NULL},  {"a108", 760, NULL}, {"a28", 754, NULL},  {"a149", 788, NULL},
    {"a172", 828, NULL},  {"a1", 974, NULL},   {"a144", 788, NULL}, {"a92", 276, NULL},
    {"a66", 786, NULL},   {"a189", 927, NULL}, {"a54", 707, NULL},  {"a59", 815, NULL},
    {"a13", 549, NULL},   {"a4", 719, NULL},   {"a82", 138, NULL},  {"a109", 626, NULL},
    {"a170", 834, NULL},  {"a201", 874, NULL}, {"a204", 759, NULL}, {"a39", 823, NULL},
    {"a197", 771, NULL},  {"a49", 695, NULL},  {"a139", 788, NULL}, {"a96", 334, NULL},
    {"a7", 552, NULL},    {"a183", 760, NULL}, {"a118", 791, NULL}, {"a155", 788, NULL},
    {"a148", 788, NULL},  {"a73", 761, NULL},  {"a75", 759, NULL},  {"a76", 892, NULL},
    {"a135", 788, NULL},  {"a177", 463, NULL}, {"a104", 910, NULL}, {"a88", 234, NULL},
    {"a142", 788, NULL},  {"a179", 836, NULL}, {"a17", 945, NULL},  {"a203", 762, NULL},
    {"a141", 788, NULL},  {"a31", 788, NULL},  {"a129", 788, NULL}, {"a35", 816, NULL},
    {"a182", 874, NULL},  {"a15", 911, NULL},  {"a38", 841, NULL},  {"a169", 928, NULL},
    {"a67", 787, NULL},   {"a45", 723, NULL},  {"a93", 317, NULL},  {"a195", 888, NULL},
    {"a68", 713, NULL},   {"a6", 494, NULL},   {"a24", 677, NULL},  {"a21", 762, NULL},
    {"a192", 748, NULL},  {"a138", 788, NULL}, {"a65", 689, NULL},  {"a84", 415, NULL},
    {"a52", 792, NULL},   {"a32", 790, NULL},  {"a33", 793, NULL},  {"a60", 789, NULL},
    {"a130", 788, NULL},  {"a180", 867, NULL}, {"a78", 788, NULL},  {"a42", 831, NULL},
    {"a196", 748, NULL},  {"a111", 595, NULL}, {"a53", 759, NULL},  {"a161", 838, NULL},
    {"a94", 317, NULL},   {"a85", 509, NULL},  {"a51", 768, NULL},  {"a181", 696, NULL},
    {"a176", 931, NULL},  {"a50", 776, NULL},  {"a173", 924, NULL}, {"a153", 788, NULL},
    {"a120", 788, NULL},  {"a122", 788, NULL}, {"a193", 836, NULL}, {"a165", 924, NULL},
    {"a19", 755, NULL},   {"a30", 788, NULL},  {"a89", 390, NULL},  {"a158", 788, NULL},
    {"a145", 788, NULL},  {"a121", 788, NULL}, {"a194", 771, NULL}, {"a64", 696, NULL},
    {"a127", 788, NULL},  {"a174", 917, NULL}, {"a69", 791, NULL},  {"a128", 788, NULL},
    {"a91", 276, NULL},   {"a63", 687, NULL},  {"a5", 789, NULL},   {"a119", 790, NULL},
    {"a12", 939, NULL},   {"a162", 924, NULL}};
...
BuiltinFont *builtinFontSubst[] = {&builtinFonts[0],  &builtinFonts[3], &builtinFonts[1],
                                   &builtinFonts[2],  &builtinFonts[4], &builtinFonts[7],
                                   &builtinFonts[5],  &builtinFonts[6], &builtinFonts[12],
                                   &builtinFonts[11], &builtinFonts[9], &builtinFonts[10]};
