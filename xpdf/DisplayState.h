...
public:
    ...
    SplashColorMode getColorMode() {
        return colorMode;
    }
    int getBitmapRowPad() {
        return bitmapRowPad;
    }
    SplashColorPtr getPaperColor() {
        return paperColor;
    }
    SplashColorPtr getMatteColor() {
        return matteColor;
    }
    SplashColorPtr getSelectColor() {
        return selectColor;
    }
    ...
    GBool displayModeIsContinuous() {
        return displayMode == displayContinuous || displayMode == displaySideBySideContinuous ||
    ...
    GBool hasSelection() {
        return selectRects != NULL;
    }
    GList *getSelectRects() {
        return selectRects;
    }
