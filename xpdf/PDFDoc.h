...
class PDFDoc {
public:
    PDFDoc(GString *fileNameA, GString *ownerPassword = NULL, GString *userPassword = NULL, PDFCore *coreA = NULL);

#ifdef _WIN32
    PDFDoc(wchar_t *fileNameA,
           int fileNameLen,
    ...
    // Windows).
    PDFDoc(char *fileNameA, GString *ownerPassword = NULL, GString *userPassword = NULL, PDFCore *coreA = NULL);

    PDFDoc(BaseStream *strA, GString *ownerPassword = NULL, GString *userPassword = NULL, PDFCore *coreA = NULL);
    ...
    void displayPages(OutputDev *out,
                      int firstPage,
                      int lastPage,
                      double hDPI,
                      double vDPI,
    ...
    void displayPageSlice(OutputDev *out,
                          int page,
                          double hDPI,
                          double vDPI,
                          int rotate,
    ...
    int getNumEmbeddedFiles() {
        return catalog->getNumEmbeddedFiles();
    }
