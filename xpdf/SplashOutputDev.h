...
public:
    // Constructor.
    SplashOutputDev(SplashColorMode colorModeA,
                    int bitmapRowPadA,
                    GBool reverseVideoA,
    ...
    virtual void drawChar(GfxState *state,
                          ...
                          int uLen);
    virtual GBool
    beginType3Char(GfxState *state, double x, double y, double dx, double dy, CharCode code, Unicode *u, int uLen);
    ...
    virtual void
    setSoftMaskFromImageMask(GfxState *state, Object *ref, Stream *str, int width, int height, GBool invert, GBool inlineImg, GBool interpolate);
    ...
    virtual void beginTransparencyGroup(GfxState *state,
                                        double *bbox,
    ...
    void setBitmapUpsideDown(GBool f) {
        bitmapUpsideDown = f;
    }
    ...
    SplashScreenParams *getScreenParams() {
        return &screenParams;
    }
...
private:
    ...
    void computeShadingColor(GfxState *state, SplashColorMode mode, GfxColor *color, SplashColorPtr sColor);
