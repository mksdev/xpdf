...
public:
    static XFAForm *load(PDFDoc *docA, Catalog *catalog, Object *acroFormObj, Object *xfaObj);
...
private:
    XFAForm(PDFDoc *docA, int nPagesA, ZxDoc *xmlA, Object *resourceDictA, GBool fullXFAA);
    ...
    void scanField(ZxElement *elem,
                   ...
                   int colSpan,
                   Catalog *catalog);
    void scanNonField(ZxElement *elem,
                      GString *name,
                      GString *fullName,
                      GBool inPageSet,
                      XFATableInfo *tableInfo,
...
private:
    ...
    void getRectangle(double *xfaX,
                      ...
                      double *pdfH,
                      int *pdfRot);
    void drawTextEdit(GfxFontDict *fontDict, double w, double h, int rot, GString *appearBuf);
    void drawCheckButton(GfxFontDict *fontDict, double w, double h, int rot, GString *appearBuf);
    void drawBarCode(GfxFontDict *fontDict, double w, double h, int rot, GString *appearBuf);
    ...
    void transform(int rot, double w, double h, double *wNew, double *hNew, GString *appearBuf);
    void drawText(GString *text,
                  GBool multiLine,
                  int combCells,
                  GString *fontName,
                  GBool bold,
                  ...
                  GString *appearBuf);
    GfxFont *findFont(GfxFontDict *fontDict, GString *fontName, GBool bold, GBool italic);
