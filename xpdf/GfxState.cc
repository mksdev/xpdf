...
// GfxState.h
static const char *gfxColorSpaceModeNames[] = {"DeviceGray", "CalGray", "DeviceRGB", "CalRGB",
                                               "DeviceCMYK", "Lab",     "ICCBased",  "Indexed",
...
void GfxColorSpace::getDefaultRanges(double *decodeLow, double *decodeRange, int maxImgPixel) {
    int i;
...
void GfxDeviceGrayColorSpace::getGray(GfxColor *color, GfxGray *gray, GfxRenderingIntent ri) {
    *gray = clip01(color->c[0]);
}

void GfxDeviceGrayColorSpace::getRGB(GfxColor *color, GfxRGB *rgb, GfxRenderingIntent ri) {
    rgb->r = rgb->g = rgb->b = clip01(color->c[0]);
}

void GfxDeviceGrayColorSpace::getCMYK(GfxColor *color, GfxCMYK *cmyk, GfxRenderingIntent ri) {
...
void GfxCalGrayColorSpace::getGray(GfxColor *color, GfxGray *gray, GfxRenderingIntent ri) {
    *gray = clip01(color->c[0]);
}

void GfxCalGrayColorSpace::getRGB(GfxColor *color, GfxRGB *rgb, GfxRenderingIntent ri) {
    rgb->r = rgb->g = rgb->b = clip01(color->c[0]);
}

void GfxCalGrayColorSpace::getCMYK(GfxColor *color, GfxCMYK *cmyk, GfxRenderingIntent ri) {
    cmyk->c = cmyk->m = cmyk->y = 0;
    cmyk->k = clip01(gfxColorComp1 - color->c[0]);
}
...
void GfxDeviceRGBColorSpace::getGray(GfxColor *color, GfxGray *gray, GfxRenderingIntent ri) {
    *gray = clip01((GfxColorComp)(0.3 * color->c[0] + 0.59 * color->c[1] + 0.11 * color->c[2] + 0.5));
}

void GfxDeviceRGBColorSpace::getRGB(GfxColor *color, GfxRGB *rgb, GfxRenderingIntent ri) {
    rgb->r = clip01(color->c[0]);
    rgb->g = clip01(color->c[1]);
    rgb->b = clip01(color->c[2]);
}

void GfxDeviceRGBColorSpace::getCMYK(GfxColor *color, GfxCMYK *cmyk, GfxRenderingIntent ri) {
...
GfxColorSpace *GfxCalRGBColorSpace::parse(Array *arr, int recursion) {
    ...
    obj2.free();
    if(obj1.dictLookup("Gamma", &obj2)->isArray() && obj2.arrayGetLength() == 3) {
        obj2.arrayGet(0, &obj3);
    ...
    obj2.free();
    if(obj1.dictLookup("Matrix", &obj2)->isArray() && obj2.arrayGetLength() == 9) {
        for(i = 0; i < 9; ++i) {
...
void GfxCalRGBColorSpace::getGray(GfxColor *color, GfxGray *gray, GfxRenderingIntent ri) {
    *gray = clip01((GfxColorComp)(0.299 * color->c[0] + 0.587 * color->c[1] + 0.114 * color->c[2] + 0.5));
}

void GfxCalRGBColorSpace::getRGB(GfxColor *color, GfxRGB *rgb, GfxRenderingIntent ri) {
    rgb->r = clip01(color->c[0]);
    rgb->g = clip01(color->c[1]);
    rgb->b = clip01(color->c[2]);
}

void GfxCalRGBColorSpace::getCMYK(GfxColor *color, GfxCMYK *cmyk, GfxRenderingIntent ri) {
    GfxColorComp c, m, y, k;
...
void GfxDeviceCMYKColorSpace::getGray(GfxColor *color, GfxGray *gray, GfxRenderingIntent ri) {
    *gray = clip01((GfxColorComp)(gfxColorComp1 - color->c[3] - 0.3 * color->c[0] -
                                  0.59 * color->c[1] - 0.11 * color->c[2] + 0.5));
}

void GfxDeviceCMYKColorSpace::getRGB(GfxColor *color, GfxRGB *rgb, GfxRenderingIntent ri) {
...
void GfxDeviceCMYKColorSpace::getCMYK(GfxColor *color, GfxCMYK *cmyk, GfxRenderingIntent ri) {
...
GfxColorSpace *GfxLabColorSpace::parse(Array *arr, int recursion) {
    ...
    obj2.free();
    if(obj1.dictLookup("Range", &obj2)->isArray() && obj2.arrayGetLength() == 4) {
        obj2.arrayGet(0, &obj3);
        cs->aMin = obj3.getNum();
        obj3.free();
        obj2.arrayGet(1, &obj3);
...
void GfxLabColorSpace::getGray(GfxColor *color, GfxGray *gray, GfxRenderingIntent ri) {
    GfxRGB rgb;
...
void GfxLabColorSpace::getRGB(GfxColor *color, GfxRGB *rgb, GfxRenderingIntent ri) {
    double X, Y, Z;
    double t1, t2;
    double r, g, b;
...
void GfxLabColorSpace::getCMYK(GfxColor *color, GfxCMYK *cmyk, GfxRenderingIntent ri) {
    GfxRGB rgb;
    GfxColorComp c, m, y, k;
...
void GfxLabColorSpace::getDefaultRanges(double *decodeLow, double *decodeRange, int maxImgPixel) {
    decodeLow[0] = 0;
    decodeRange[0] = 100;
    decodeLow[1] = aMin;
...
GfxICCBasedColorSpace::GfxICCBasedColorSpace(int nCompsA, GfxColorSpace *altA, Ref *iccProfileStreamA) {
    nComps = nCompsA;
    alt = altA;
...
GfxColorSpace *GfxICCBasedColorSpace::parse(Array *arr, int recursion) {
    ...
    if(dict->lookup("Alternate", &obj2)->isNull() || !(altA = GfxColorSpace::parse(&obj2, recursion + 1))) {
        switch(nCompsA) {
            case 1:
...
void GfxICCBasedColorSpace::getGray(GfxColor *color, GfxGray *gray, GfxRenderingIntent ri) {
    alt->getGray(color, gray, ri);
}

void GfxICCBasedColorSpace::getRGB(GfxColor *color, GfxRGB *rgb, GfxRenderingIntent ri) {
    alt->getRGB(color, rgb, ri);
}

void GfxICCBasedColorSpace::getCMYK(GfxColor *color, GfxCMYK *cmyk, GfxRenderingIntent ri) {
...
void GfxICCBasedColorSpace::getDefaultRanges(double *decodeLow, double *decodeRange, int maxImgPixel) {
...
GfxIndexedColorSpace::GfxIndexedColorSpace(GfxColorSpace *baseA, int indexHighA) {
    ...
    lookup = (Guchar *)gmallocn((indexHigh + 1) * base->getNComps(), sizeof(Guchar));
...
GfxColorSpace *GfxIndexedColorSpace::copy() {
    ...
    memcpy(cs->lookup, lookup, (indexHigh + 1) * base->getNComps() * sizeof(Guchar));
    return cs;
}
...
GfxColorSpace *GfxIndexedColorSpace::parse(Array *arr, int recursion) {
    ...
    if(obj1.isStream()) {
        ...
        for(i = 0; i <= indexHighA; ++i) {
            for(j = 0; j < n; ++j) {
                if((x = obj1.streamGetChar()) == EOF) {
                    error(errSyntaxError, -1, "Bad Indexed color space (lookup table stream too short)");
        ...
        if(obj1.getString()->getLength() < (indexHighA + 1) * n) {
            error(errSyntaxError, -1, "Bad Indexed color space (lookup table string too short)");
...
GfxColor *GfxIndexedColorSpace::mapColorToBase(GfxColor *color, GfxColor *baseColor) {
    Guchar *p;
...
void GfxIndexedColorSpace::getGray(GfxColor *color, GfxGray *gray, GfxRenderingIntent ri) {
    GfxColor color2;

    base->getGray(mapColorToBase(color, &color2), gray, ri);
}

void GfxIndexedColorSpace::getRGB(GfxColor *color, GfxRGB *rgb, GfxRenderingIntent ri) {
    GfxColor color2;

    base->getRGB(mapColorToBase(color, &color2), rgb, ri);
}

void GfxIndexedColorSpace::getCMYK(GfxColor *color, GfxCMYK *cmyk, GfxRenderingIntent ri) {
    GfxColor color2;
...
void GfxIndexedColorSpace::getDefaultRanges(double *decodeLow, double *decodeRange, int maxImgPixel) {
    decodeLow[0] = 0;
...
GfxSeparationColorSpace::GfxSeparationColorSpace(GString *nameA, GfxColorSpace *altA, Function *funcA) {
    name = nameA;
    alt = altA;
    func = funcA;
...
GfxColorSpace *GfxSeparationColorSpace::copy() {
    ...
    cs = new GfxSeparationColorSpace(name->copy(), alt->copy(), func->copy(), nonMarking, overprintMask);
    return cs;
}
...
GfxColorSpace *GfxSeparationColorSpace::parse(Array *arr, int recursion) {
    ...
    if(obj1.isStream() && !obj1.streamGetDict()->lookup("Alternate", &obj2)->isNull()) {
        obj1.free();
        obj1 = obj2;
    }
...
void GfxSeparationColorSpace::getGray(GfxColor *color, GfxGray *gray, GfxRenderingIntent ri) {
    double x;
...
void GfxSeparationColorSpace::getRGB(GfxColor *color, GfxRGB *rgb, GfxRenderingIntent ri) {
    double x;
    double c[gfxColorMaxComps];
    GfxColor color2;
    int i;
...
void GfxSeparationColorSpace::getCMYK(GfxColor *color, GfxCMYK *cmyk, GfxRenderingIntent ri) {
    double x;
    double c[gfxColorMaxComps];
    GfxColor color2;
    int i;
...
GfxDeviceNColorSpace::GfxDeviceNColorSpace(int nCompsA, GString **namesA, GfxColorSpace *altA, Function *funcA, Object *attrsA) {
    int i;
...
GfxColorSpace *GfxDeviceNColorSpace::copy() {
    ...
    cs = new GfxDeviceNColorSpace(nComps, names, alt->copy(), func->copy(), &attrs, nonMarking, overprintMask);
    return cs;
}
...
GfxColorSpace *GfxDeviceNColorSpace::parse(Array *arr, int recursion) {
    ...
    if(nCompsA > gfxColorMaxComps) {
        error(errSyntaxError, -1, "DeviceN color space with too many ({0:d} > {1:d}) components",
...
void GfxDeviceNColorSpace::getGray(GfxColor *color, GfxGray *gray, GfxRenderingIntent ri) {
...
void GfxDeviceNColorSpace::getRGB(GfxColor *color, GfxRGB *rgb, GfxRenderingIntent ri) {
    double x[gfxColorMaxComps], c[gfxColorMaxComps];
    GfxColor color2;
    int i;
...
void GfxDeviceNColorSpace::getCMYK(GfxColor *color, GfxCMYK *cmyk, GfxRenderingIntent ri) {
    double x[gfxColorMaxComps], c[gfxColorMaxComps];
    GfxColor color2;
    int i;
...
void GfxPatternColorSpace::getGray(GfxColor *color, GfxGray *gray, GfxRenderingIntent ri) {
    *gray = 0;
}

void GfxPatternColorSpace::getRGB(GfxColor *color, GfxRGB *rgb, GfxRenderingIntent ri) {
    rgb->r = rgb->g = rgb->b = 0;
}

void GfxPatternColorSpace::getCMYK(GfxColor *color, GfxCMYK *cmyk, GfxRenderingIntent ri) {
    cmyk->c = cmyk->m = cmyk->y = 0;
    cmyk->k = 1;
}
...
GfxTilingPattern *GfxTilingPattern::parse(Object *patObjRef, Object *patObj) {
    ...
    bboxA[0] = bboxA[1] = 0;
    bboxA[2] = bboxA[3] = 1;
    if(dict->lookup("BBox", &obj1)->isArray() && obj1.arrayGetLength() == 4) {
        for(i = 0; i < 4; ++i) {
    ...
    matrixA[4] = 0;
    matrixA[5] = 0;
    if(dict->lookup("Matrix", &obj1)->isArray() && obj1.arrayGetLength() == 6) {
        for(i = 0; i < 6; ++i) {
            if(obj1.arrayGet(i, &obj2)->isNum()) {
    ...
    pat = new GfxTilingPattern(paintTypeA, tilingTypeA, bboxA, xStepA, yStepA, &resDictA, matrixA, patObjRef);
    resDictA.free();
    return pat;
}
...
GfxPattern *GfxTilingPattern::copy() {
    return new GfxTilingPattern(paintType, tilingType, bbox, xStep, yStep, &resDict, matrix, &contentStreamRef);
}
...
GfxShadingPattern::GfxShadingPattern(GfxShading *shadingA, double *matrixA) : GfxPattern(2) {
    int i;
...
GfxFunctionShading::GfxFunctionShading(double x0A, double y0A, double x1A, double y1A, double *matrixA, Function **funcsA, int nFuncsA)
    : GfxShading(1) {
    int i;
...
GfxFunctionShading::GfxFunctionShading(GfxFunctionShading *shading) : GfxShading(shading) {
    int i;
...
GfxFunctionShading *GfxFunctionShading::parse(Dict *dict) {
    ...
    x0A = y0A = 0;
    x1A = y1A = 1;
    if(dict->lookup("Domain", &obj1)->isArray() && obj1.arrayGetLength() == 4) {
    ...
    if(obj1.isArray()) {
        ...
        if(nFuncsA > gfxColorMaxComps) {
            error(errSyntaxError, -1, "Invalid Function array in shading dictionary");
            goto err1;
        }
        for(i = 0; i < nFuncsA; ++i) {
    ...
    for(i = 0; i < shading->nFuncs; ++i) {
        if(shading->funcs[i]->getOutputSize() != shading->getColorSpace()->getNComps()) {
...
GfxAxialShading::GfxAxialShading(GfxAxialShading *shading) : GfxShading(shading) {
    int i;
...
GfxAxialShading *GfxAxialShading::parse(Dict *dict) {
    ...
    x0A = y0A = x1A = y1A = 0;
    if(dict->lookup("Coords", &obj1)->isArray() && obj1.arrayGetLength() == 4) {
        x0A = obj1.arrayGet(0, &obj2)->getNum();
        obj2.free();
        ...
        error(errSyntaxError, -1, "Missing or invalid Coords in shading dictionary");
        obj1.free();
        goto err1;
    }
    obj1.free();
    ...
    t0A = 0;
    t1A = 1;
    if(dict->lookup("Domain", &obj1)->isArray() && obj1.arrayGetLength() == 2) {
    ...
    if(dict->lookup("Extend", &obj1)->isArray() && obj1.arrayGetLength() == 2) {
...
GfxRadialShading::GfxRadialShading(GfxRadialShading *shading) : GfxShading(shading) {
    int i;
...
GfxRadialShading *GfxRadialShading::parse(Dict *dict) {
    ...
    if(dict->lookup("Coords", &obj1)->isArray() && obj1.arrayGetLength() == 6) {
        x0A = obj1.arrayGet(0, &obj2)->getNum();
        obj2.free();
        y0A = obj1.arrayGet(1, &obj2)->getNum();
        obj2.free();
...
GfxGouraudTriangleShading::GfxGouraudTriangleShading(int typeA,
...
GfxGouraudTriangleShading::GfxGouraudTriangleShading(GfxGouraudTriangleShading *shading)
    : GfxShading(shading) {
    int i;
...
GfxGouraudTriangleShading *GfxGouraudTriangleShading::parse(int typeA, Dict *dict, Stream *str) {
    ...
    if(dict->lookup("BitsPerCoordinate", &obj1)->isInt()) {
        ...
        error(errSyntaxError, -1, "Missing or invalid BitsPerCoordinate in shading dictionary");
        goto err2;
    }
    obj1.free();
    if(dict->lookup("BitsPerComponent", &obj1)->isInt()) {
        ...
        error(errSyntaxError, -1, "Missing or invalid BitsPerComponent in shading dictionary");
        goto err2;
    }
    obj1.free();
    ...
    if(typeA == 4) {
        if(dict->lookup("BitsPerFlag", &obj1)->isInt()) {
            ...
            error(errSyntaxError, -1, "Missing or invalid BitsPerFlag in shading dictionary");
            goto err2;
        }
        obj1.free();
    } else {
        if(dict->lookup("VerticesPerRow", &obj1)->isInt()) {
            ...
            error(errSyntaxError, -1, "Missing or invalid VerticesPerRow in shading dictionary");
            goto err2;
        }
        obj1.free();
    }
    if(dict->lookup("Decode", &obj1)->isArray() && obj1.arrayGetLength() >= 6) {
        xMin = obj1.arrayGet(0, &obj2)->getNum();
        obj2.free();
        ...
        error(errSyntaxError, -1, "Missing or invalid Decode array in shading dictionary");
        goto err2;
    }
    obj1.free();
    ...
    while(1) {
        ...
        if(nVerticesA == vertSize) {
            ...
            verticesA = (GfxGouraudVertex *)greallocn(verticesA, vertSize, sizeof(GfxGouraudVertex));
        }
    ...
    shading = new GfxGouraudTriangleShading(typeA, verticesA, nVerticesA, trianglesA, nTrianglesA,
...
GfxPatchMeshShading::GfxPatchMeshShading(int typeA, GfxPatch *patchesA, int nPatchesA, int nCompsA, Function **funcsA, int nFuncsA)
    : GfxShading(typeA) {
    int i;
...
GfxPatchMeshShading::GfxPatchMeshShading(GfxPatchMeshShading *shading) : GfxShading(shading) {
    int i;
...
GfxPatchMeshShading *GfxPatchMeshShading::parse(int typeA, Dict *dict, Stream *str) {
    ...
    while(1) {
        ...
        if(nPatchesA == patchesSize) {
            ...
            patchesA = (GfxPatch *)greallocn(patchesA, patchesSize, sizeof(GfxPatch));
        }
    ...
    if(typeA == 6) {
        for(i = 0; i < nPatchesA; ++i) {
            ...
            p->x[1][1] = (-4 * p->x[0][0] + 6 * (p->x[0][1] + p->x[1][0]) -
                          2 * (p->x[0][3] + p->x[3][0]) + 3 * (p->x[3][1] + p->x[1][3]) - p->x[3][3]) /
                         9;
            p->y[1][1] = (-4 * p->y[0][0] + 6 * (p->y[0][1] + p->y[1][0]) -
                          2 * (p->y[0][3] + p->y[3][0]) + 3 * (p->y[3][1] + p->y[1][3]) - p->y[3][3]) /
                         9;
            p->x[1][2] = (-4 * p->x[0][3] + 6 * (p->x[0][2] + p->x[1][3]) -
                          2 * (p->x[0][0] + p->x[3][3]) + 3 * (p->x[3][2] + p->x[1][0]) - p->x[3][0]) /
                         9;
            p->y[1][2] = (-4 * p->y[0][3] + 6 * (p->y[0][2] + p->y[1][3]) -
                          2 * (p->y[0][0] + p->y[3][3]) + 3 * (p->y[3][2] + p->y[1][0]) - p->y[3][0]) /
                         9;
            p->x[2][1] = (-4 * p->x[3][0] + 6 * (p->x[3][1] + p->x[2][0]) -
                          2 * (p->x[3][3] + p->x[0][0]) + 3 * (p->x[0][1] + p->x[2][3]) - p->x[0][3]) /
                         9;
            p->y[2][1] = (-4 * p->y[3][0] + 6 * (p->y[3][1] + p->y[2][0]) -
                          2 * (p->y[3][3] + p->y[0][0]) + 3 * (p->y[0][1] + p->y[2][3]) - p->y[0][3]) /
                         9;
            p->x[2][2] = (-4 * p->x[3][3] + 6 * (p->x[3][2] + p->x[2][3]) -
                          2 * (p->x[3][0] + p->x[0][3]) + 3 * (p->x[0][2] + p->x[2][0]) - p->x[0][0]) /
                         9;
            p->y[2][2] = (-4 * p->y[3][3] + 6 * (p->y[3][2] + p->y[2][3]) -
                          2 * (p->y[3][0] + p->y[0][3]) + 3 * (p->y[0][2] + p->y[2][0]) - p->y[0][0]) /
                         9;
        }
    }

    shading = new GfxPatchMeshShading(typeA, patchesA, nPatchesA, nCompsA, funcsA, nFuncsA);
    if(!shading->init(dict)) {
        delete shading;
        return NULL;
    }
...
GfxImageColorMap::GfxImageColorMap(int bitsA, Object *decode, GfxColorSpace *colorSpaceA, int maxAllowedBits) {
...
void GfxImageColorMap::getGray(Guchar *x, GfxGray *gray, GfxRenderingIntent ri) {
    GfxColor color;
    int i;
...
void GfxImageColorMap::getCMYK(Guchar *x, GfxCMYK *cmyk, GfxRenderingIntent ri) {
    GfxColor color;
    int i;
...
void GfxImageColorMap::getGrayByteLine(Guchar *in, Guchar *out, int n, GfxRenderingIntent ri) {
    GfxColor color;
    GfxGray gray;
    int i, j;
...
void GfxImageColorMap::getRGBByteLine(Guchar *in, Guchar *out, int n, GfxRenderingIntent ri) {
    GfxColor color;
    GfxRGB rgb;
    int i, j;
...
void GfxImageColorMap::getCMYKByteLine(Guchar *in, Guchar *out, int n, GfxRenderingIntent ri) {
    GfxColor color;
    GfxCMYK cmyk;
    int i, j;
...
// Used for copy().
GfxPath::GfxPath(GBool justMoved1, double firstX1, double firstY1, GfxSubpath **subpaths1, int n1, int size1) {
    int i;
...
GfxState::GfxState(double hDPIA, double vDPIA, PDFRectangle *pageBox, int rotateA, GBool upsideDown) {
    double kx, ky;
...
void GfxState::getUserClipBBox(double *xMin, double *yMin, double *xMax, double *yMax) {
    double ictm[6];
