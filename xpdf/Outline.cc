...
GList *OutlineItem::readItemList(Object *firstItemRef, Object *lastItemRef, OutlineItem *parentA, XRef *xrefA) {
    GList *items;
    ...
    do {
        ...
        for(i = 0; i < items->getLength(); ++i) {
            ...
            if(p->getRefNum() == sibling->itemRef.getRefNum() && p->getRefGen() == sibling->itemRef.getRefGen()) {
                error(errSyntaxError, -1, "Loop detected in outline");
                break;
            }
        }
