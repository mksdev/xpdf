...
public:
    ...
    Object *getAppearance(Object *obj) {
        return appearance.fetch(xref, obj);
    }
...
private:
    ...
    void
    adjustLineEndpoint(AnnotLineEndType lineEnd, double x, double y, double dx, double dy, double w, double *tx, double *ty);
...
private:
    void scanFieldAppearances(Dict *node, Ref *ref, Dict *parent, Dict *acroForm);
