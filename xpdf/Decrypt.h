...
public:
    ...
    static GBool makeFileKey(int encVersion,
                             int encRevision,
                             int keyLength,
                             GString *ownerKey,
                             GString *userKey,
...
private:
    static void r6Hash(Guchar *key, int keyLen, const char *pwd, int pwdLen, char *userKey);
    static GBool makeFileKey2(int encVersion,
                              int encRevision,
                              int keyLength,
                              GString *ownerKey,
                              GString *userKey,
...
public:
    DecryptStream(Stream *strA, Guchar *fileKeyA, CryptAlgorithm algoA, int keyLengthA, int objNumA, int objGenA);
...
extern void aesKeyExpansion(DecryptAESState *s, Guchar *objKey, int objKeyLen, GBool decrypt);
