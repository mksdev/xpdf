...
public:
    ...
    virtual bool isXMLDecl() {
        return false;
    }
    virtual bool isDocTypeDecl() {
        return false;
    }
    ...
    virtual bool isElement(const char *type) {
        return false;
    }
    virtual bool isCharData() {
        return false;
    }
    virtual ZxNode *getFirstChild() {
        return firstChild;
    }
    virtual ZxNode *getNextChild() {
        return next;
    }
    ZxNode *getParent() {
        return parent;
...
public:
    ...
    ZxXMLDecl *getXMLDecl() {
        return xmlDecl;
    }
    ZxDocTypeDecl *getDocTypeDecl() {
        return docTypeDecl;
    }
    ZxElement *getRoot() {
        return root;
