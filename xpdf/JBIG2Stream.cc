...
JBIG2HuffmanTable huffTableA[] = {{0, 1, 4, 0x000},
                                  {16, 2, 8, 0x002},
                                  {272, 3, 16, 0x006},
                                  {65808, 3, 32, 0x007},
                                  {0, 0, jbig2HuffmanEOT, 0}};

JBIG2HuffmanTable huffTableB[] = {{0, 1, 0, 0x000},
                                  {1, 2, 0, 0x002},
                                  {2, 3, 0, 0x006},
                                  {3, 4, 3, 0x00e},
                                  {11, 5, 6, 0x01e},
...
JBIG2HuffmanTable huffTableC[] = {
    {0, 1, 0, 0x000},          {1, 2, 0, 0x002},    {2, 3, 0, 0x006},
    {3, 4, 3, 0x00e},          {11, 5, 6, 0x01e},   {0, 6, jbig2HuffmanOOB, 0x03e},
    {75, 7, 32, 0x0fe},        {-256, 8, 8, 0x0fe}, {-257, 8, jbig2HuffmanLOW, 0x0ff},
    {0, 0, jbig2HuffmanEOT, 0}};

JBIG2HuffmanTable huffTableD[] = {{1, 1, 0, 0x000},          {2, 2, 0, 0x002},  {3, 3, 0, 0x006},
                                  {4, 4, 3, 0x00e},          {12, 5, 6, 0x01e}, {76, 5, 32, 0x01f},
                                  {0, 0, jbig2HuffmanEOT, 0}};

JBIG2HuffmanTable huffTableE[] = {{1, 1, 0, 0x000},          {2, 2, 0, 0x002},
                                  {3, 3, 0, 0x006},          {4, 4, 3, 0x00e},
                                  {12, 5, 6, 0x01e},         {76, 6, 32, 0x03e},
                                  {-255, 7, 8, 0x07e},       {-256, 7, jbig2HuffmanLOW, 0x07f},
                                  {0, 0, jbig2HuffmanEOT, 0}};

JBIG2HuffmanTable huffTableF[] = {{0, 2, 7, 0x000},
                                  {128, 3, 7, 0x002},
                                  {256, 3, 8, 0x003},
                                  {-1024, 4, 9, 0x008},
                                  {-512, 4, 8, 0x009},
...
JBIG2HuffmanTable huffTableG[] = {{-512, 3, 8, 0x000},  {256, 3, 8, 0x001},
                                  {512, 3, 9, 0x002},   {1024, 3, 10, 0x003},
                                  {-1024, 4, 9, 0x008}, {-256, 4, 7, 0x009},
                                  {-32, 4, 5, 0x00a},   {0, 4, 5, 0x00b},
                                  {128, 4, 7, 0x00c},   {-128, 5, 6, 0x01a},
                                  {-64, 5, 5, 0x01b},   {32, 5, 5, 0x01c},
                                  {64, 5, 6, 0x01d},    {-1025, 5, jbig2HuffmanLOW, 0x01e},
                                  {2048, 5, 32, 0x01f}, {0, 0, jbig2HuffmanEOT, 0}};

JBIG2HuffmanTable huffTableH[] = {{0, 2, 1, 0x000},     {0, 2, jbig2HuffmanOOB, 0x001},
...
JBIG2HuffmanTable huffTableI[] = {{0, 2, jbig2HuffmanOOB, 0x000},
                                  {-1, 3, 1, 0x002},
                                  {1, 3, 1, 0x003},
                                  {7, 3, 5, 0x004},
                                  {-3, 4, 1, 0x00a},
...
JBIG2HuffmanTable huffTableJ[] = {{-2, 2, 2, 0x000},
                                  {6, 2, 6, 0x001},
...
JBIG2HuffmanTable huffTableK[] = {{1, 1, 0, 0x000},    {2, 2, 1, 0x002},          {4, 4, 0, 0x00c},
                                  {5, 4, 1, 0x00d},    {7, 5, 1, 0x01c},          {9, 5, 2, 0x01d},
                                  {13, 6, 2, 0x03c},   {17, 7, 2, 0x07a},         {21, 7, 3, 0x07b},
                                  {29, 7, 4, 0x07c},   {45, 7, 5, 0x07d},         {77, 7, 6, 0x07e},
                                  {141, 7, 32, 0x07f}, {0, 0, jbig2HuffmanEOT, 0}};

JBIG2HuffmanTable huffTableL[] = {{1, 1, 0, 0x000},   {2, 2, 0, 0x002},          {3, 3, 1, 0x006},
                                  {5, 5, 0, 0x01c},   {6, 5, 1, 0x01d},          {8, 6, 1, 0x03c},
                                  {10, 7, 0, 0x07a},  {11, 7, 1, 0x07b},         {13, 7, 2, 0x07c},
                                  {17, 7, 3, 0x07d},  {25, 7, 4, 0x07e},         {41, 8, 5, 0x0fe},
                                  {73, 8, 32, 0x0ff}, {0, 0, jbig2HuffmanEOT, 0}};

JBIG2HuffmanTable huffTableM[] = {{1, 1, 0, 0x000},    {2, 3, 0, 0x004},          {7, 3, 3, 0x005},
                                  {3, 4, 0, 0x00c},    {5, 4, 1, 0x00d},          {4, 5, 0, 0x01c},
                                  {15, 6, 1, 0x03a},   {17, 6, 2, 0x03b},         {21, 6, 3, 0x03c},
                                  {29, 6, 4, 0x03d},   {45, 6, 5, 0x03e},         {77, 7, 6, 0x07e},
                                  {141, 7, 32, 0x07f}, {0, 0, jbig2HuffmanEOT, 0}};

JBIG2HuffmanTable huffTableN[] = {{0, 1, 0, 0x000}, {-2, 3, 0, 0x004}, {-1, 3, 0, 0x005},
                                  {1, 3, 0, 0x006}, {2, 3, 0, 0x007},  {0, 0, jbig2HuffmanEOT, 0}};

JBIG2HuffmanTable huffTableO[] = {{0, 1, 0, 0x000},   {-1, 3, 0, 0x004},
                                  {1, 3, 0, 0x005},   {-2, 4, 0, 0x00c},
                                  {2, 4, 0, 0x00d},   {-4, 5, 1, 0x01c},
                                  {3, 5, 1, 0x01d},   {-8, 6, 2, 0x03c},
                                  {5, 6, 2, 0x03d},   {-24, 7, 4, 0x07c},
                                  {9, 7, 4, 0x07d},   {-25, 7, jbig2HuffmanLOW, 0x07e},
...
public:
    ...
    int getPixel(int x, int y) {
        return (x < 0 || x >= w || y < 0 || y >= h) ? 0 : (data[y * line + (x >> 3)] >> (7 - (x & 7))) & 1;
    }
...
JBIG2Bitmap::JBIG2Bitmap(Guint segNumA, int wA, int hA) : JBIG2Segment(segNumA) {
    w = wA;
    h = hA;
    line = (wA + 7) >> 3;
...
JBIG2Bitmap::JBIG2Bitmap(Guint segNumA, JBIG2Bitmap *bitmap) : JBIG2Segment(segNumA) {
    w = bitmap->w;
    h = bitmap->h;
    line = bitmap->line;
    if(w <= 0 || h <= 0 || line <= 0 || h >= (INT_MAX - 1) / line) {
...
void JBIG2Bitmap::combine(JBIG2Bitmap *bitmap, int x, int y, Guint combOp) {
...
JBIG2SymbolDict::JBIG2SymbolDict(Guint segNumA, Guint sizeA) : JBIG2Segment(segNumA) {
    Guint i;
...
JBIG2PatternDict::JBIG2PatternDict(Guint segNumA, Guint sizeA) : JBIG2Segment(segNumA) {
    size = sizeA;
    bitmaps = (JBIG2Bitmap **)gmallocn(size, sizeof(JBIG2Bitmap *));
}
...
JBIG2CodeTable::JBIG2CodeTable(Guint segNumA, JBIG2HuffmanTable *tableA) : JBIG2Segment(segNumA) {
    table = tableA;
}
...
JBIG2Stream::JBIG2Stream(Stream *strA, Object *globalsStreamA) : FilterStream(strA) {
    pageBitmap = NULL;
...
void JBIG2Stream::readSegments() {
    ...
    while(!done && readULong(&segNum)) {
        ...
        nRefSegs = refFlags >> 5;
        if(nRefSegs == 7) {
            if((c1 = curStr->getChar()) == EOF || (c2 = curStr->getChar()) == EOF ||
        ...
        switch(segType) {
            ...
            case 16:
                ...
                break;
            case 20:
                readHalftoneRegionSeg(segNum, gFalse, gFalse, segLength, refSegs, nRefSegs);
                break;
            case 22:
                readHalftoneRegionSeg(segNum, gTrue, gFalse, segLength, refSegs, nRefSegs);
                break;
            case 23:
                readHalftoneRegionSeg(segNum, gTrue, gTrue, segLength, refSegs, nRefSegs);
                break;
            case 36:
            ...
            case 39:
                ...
                break;
            case 40:
                readGenericRefinementRegionSeg(segNum, gFalse, gFalse, segLength, refSegs, nRefSegs);
                break;
            case 42:
                readGenericRefinementRegionSeg(segNum, gTrue, gFalse, segLength, refSegs, nRefSegs);
                break;
            case 43:
                readGenericRefinementRegionSeg(segNum, gTrue, gTrue, segLength, refSegs, nRefSegs);
                break;
            case 48:
        ...
        if(!(segType == 38 && segLength == 0xffffffff)) {
            ...
            if(byteCounter > segLength || segLength - byteCounter > 65536) {
                error(errSyntaxError, getPos(), "Invalid segment length in JBIG2 stream");
                gfree(refSegs);
                break;
            }
...
GBool JBIG2Stream::readSymbolDictSeg(Guint segNum, Guint length, Guint *refSegs, Guint nRefSegs) {
    ...
    if(!huff) {
        if(sdTemplate == 0) {
            if(!readByte(&sdATX[0]) || !readByte(&sdATY[0]) || !readByte(&sdATX[1]) ||
               !readByte(&sdATY[1]) || !readByte(&sdATX[2]) || !readByte(&sdATY[2]) ||
               !readByte(&sdATX[3]) || !readByte(&sdATY[3])) {
                goto eofError;
            }
        } else {
        ...
        if((seg = findSegment(refSegs[i]))) {
            if(seg->getType() == jbig2SegSymbolDict) {
                ...
                if(j > INT_MAX || numInputSyms > INT_MAX - j) {
                    error(errSyntaxError, getPos(), "Too many input symbols in JBIG2 symbol dictionary");
                    delete codeTables;
                    goto eofError;
                }
                numInputSyms += j;
    ...
    bitmaps = (JBIG2Bitmap **)gmallocn(numInputSyms + numNewSyms, sizeof(JBIG2Bitmap *));
    ...
    if(huff) {
        ...
        if(huffBMSize == 0) {
            ...
            huffBMSizeTable = ((JBIG2CodeTable *)codeTables->get(i++))->getHuffTable();
        }
        if(huffAggInst == 0) {
            ...
            huffAggInstTable = ((JBIG2CodeTable *)codeTables->get(i++))->getHuffTable();
        }
    }
    delete codeTables;
    ...
    while(i < numNewSyms) {
        ...
        if((dh <= 0 && (Guint)-dh >= symHeight) || (dh > 0 && (Guint)dh > UINT_MAX - symHeight)) {
            error(errSyntaxError, getPos(), "Bad delta-height value in JBIG2 symbol dictionary");
            goto syntaxError;
        }
        // sanity check to avoid extremely long run-times with damaged streams
        if(dh > 1000000) {
            error(errSyntaxError, getPos(), "Bogus delta-height value in JBIG2 symbol dictionary");
            goto syntaxError;
        }
        symHeight += dh;
        symWidth = 0;
        ...
        while(1) {
            ...
            if((dw <= 0 && (Guint)-dw >= symWidth) || (dw > 0 && (Guint)dw > UINT_MAX - symWidth)) {
                error(errSyntaxError, getPos(), "Bad delta-height value in JBIG2 symbol dictionary");
                goto syntaxError;
            }
            symWidth += dw;
            if(i >= numNewSyms) {
                error(errSyntaxError, getPos(), "Too many symbols in JBIG2 symbol dictionary");
                goto syntaxError;
            }
	...
	if (0) {
                ...
                if(symID >= numInputSyms + i) {
                    error(errSyntaxError, getPos(), "Invalid symbol ID in JBIG2 symbol dictionary");
                    goto syntaxError;
                }
                refBitmap = bitmaps[symID];
                bitmaps[numInputSyms + i] =
                    readGenericRefinementRegion(symWidth, symHeight, sdrTemplate, gFalse, refBitmap,
                                                refDX, refDY, sdrATX, sdrATY);
                //~ do we need to use the bmSize value here (in Huffman mode)?
            } else {
                bitmaps[numInputSyms + i] =
                    readTextRegion(huff, gTrue, symWidth, symHeight, refAggNum, 0, numInputSyms + i,
                                   NULL, symCodeLen, bitmaps, 0, 0, 0, 1, 0, huffTableF, huffTableH,
                                   huffTableK, huffTableO, huffTableO, huffTableO, huffTableO,
                                   huffTableA, sdrTemplate, sdrATX, sdrATY);
            }

            // non-ref/agg coding
        }
        else {
            bitmaps[numInputSyms + i] = readGenericBitmap(gFalse, symWidth, symHeight, sdTemplate,
                                                          gFalse, gFalse, NULL, sdATX, sdATY, 0);
        }
    ...
    if(huff && !refAgg) {
        if(totalWidth == 0) {
            error(errSyntaxError, getPos(), "Invalid height class width in JBIG2 symbol dictionary");
            goto syntaxError;
        }
        ...
        if(bmSize == 0) {
            ...
            byteCounter += curStr->getBlock((char *)collBitmap->getDataPtr(), bmSize);
        } else {
            collBitmap = readGenericBitmap(gTrue, totalWidth, symHeight, 0, gFalse, gFalse, NULL,
                                           NULL, NULL, bmSize);
        }
        x = 0;
        for(; j < i; ++j) {
...
while(i < numInputSyms + numNewSyms) {
    ...
    if(run == 0 && prevRun == 0) {
        ...
        error(errSyntaxError, getPos(), "Invalid exported symbol list in JBIG2 symbol dictionary");
        delete symbolDict;
        goto syntaxError;
    }
    if(i + run > numInputSyms + numNewSyms || (ex && j + run > numExSyms)) {
        error(errSyntaxError, getPos(), "Too many exported symbols in JBIG2 symbol dictionary");
        delete symbolDict;
        goto syntaxError;
    }
    if(ex) {
...
codeTableError : error(errSyntaxError, getPos(), "Missing code table in JBIG2 symbol dictionary");
delete codeTables;
...
void JBIG2Stream::readTextRegionSeg(Guint segNum, GBool imm, GBool lossless, Guint length, Guint *refSegs, Guint nRefSegs) {
    JBIG2Bitmap *bitmap;
    ...
    for(i = 0; i < nRefSegs; ++i) {
        if((seg = findSegment(refSegs[i]))) {
            ...
            error(errSyntaxError, getPos(), "Invalid segment reference in JBIG2 text region");
            delete codeTables;
            return;
        }
    }
    ...
    if(huff) {
        ...
        if(huffRSize == 0) {
            ...
            huffRSizeTable = ((JBIG2CodeTable *)codeTables->get(i++))->getHuffTable();
        }
    }
    delete codeTables;
    ...
    bitmap = readTextRegion(huff, refine, w, h, numInstances, logStrips, numSyms, symCodeTab,
                            symCodeLen, syms, defPixel, combOp, transposed, refCorner, sOffset,
    ...
    while(inst < numInstances) {
        ...
        while(inst < numInstances) {
            ...
            if(symID >= (Guint)numSyms) {
                error(errSyntaxError, getPos(), "Invalid symbol number in JBIG2 text region");
            } else {
                ...
                if(ri) {
                    ...
                    symbolBitmap = readGenericRefinementRegion(rdw + syms[symID]->getWidth(),
                                                               rdh + syms[symID]->getHeight(), templ, gFalse,
                                                               syms[symID], refDX, refDY, atx, aty);
                    //~ do we need to use the bmSize value here (in Huffman mode)?
                } else {
...
void JBIG2Stream::readPatternDictSeg(Guint segNum, Guint length) {
    ...
    if(patternW == 0 || patternH == 0) {
        error(errSyntaxError, getPos(), "Bad size in JBIG2 pattern dictionary segment");
        return;
    }
    templ = (flags >> 1) & 3;
    mmr = flags & 1;
    ...
    atx[3] = -2;
    aty[3] = -2;
    bitmap = readGenericBitmap(mmr, (grayMax + 1) * patternW, patternH, templ, gFalse, gFalse, NULL,
                               atx, aty, length - 7);
...
void JBIG2Stream::readHalftoneRegionSeg(Guint segNum, GBool imm, GBool lossless, Guint length, Guint *refSegs, Guint nRefSegs) {
    JBIG2Bitmap *bitmap;
    JBIG2Segment *seg;
    JBIG2PatternDict *patternDict;
    ...
    combOp = (flags >> 4) & 7;
    if(!readULong(&gridW) || !readULong(&gridH) || !readLong(&gridX) || !readLong(&gridY) ||
       !readUWord(&stepX) || !readUWord(&stepY)) {
        goto eofError;
    }
    if(w == 0 || h == 0 || w >= INT_MAX / h) {
        error(errSyntaxError, getPos(), "Bad bitmap size in JBIG2 halftone segment");
        return;
    }
    ...
    if(nRefSegs != 1) {
        error(errSyntaxError, getPos(), "Bad symbol dictionary reference in JBIG2 halftone segment");
        return;
    }
    if(!(seg = findSegment(refSegs[0])) || seg->getType() != jbig2SegPatternDict) {
        error(errSyntaxError, getPos(), "Bad symbol dictionary reference in JBIG2 halftone segment");
        return;
    }
    ...
    for(j = bpp - 1; j >= 0; --j) {
        grayBitmap =
            readGenericBitmap(mmr, gridW, gridH, templ, gFalse, enableSkip, skipBitmap, atx, aty, -1);
        i = 0;
        for(m = 0; m < gridH; ++m) {
            for(n = 0; n < gridW; ++n) {
...
void JBIG2Stream::readGenericRegionSeg(Guint segNum, GBool imm, GBool lossless, Guint length) {
    JBIG2Bitmap *bitmap;
    ...
    if(w == 0 || h == 0) {
        error(errSyntaxError, getPos(), "Bad bitmap size in JBIG2 generic region segment");
        return;
    }
    extCombOp = segInfoFlags & 7;
    ...
    if(!mmr) {
        if(templ == 0) {
            if(!readByte(&atx[0]) || !readByte(&aty[0]) || !readByte(&atx[1]) || !readByte(&aty[1]) ||
               !readByte(&atx[2]) || !readByte(&aty[2]) || !readByte(&atx[3]) || !readByte(&aty[3])) {
                goto eofError;
            }
        } else {
    ...
    // read the bitmap
    bitmap = readGenericBitmap(mmr, w, h, templ, tpgdOn, gFalse, NULL, atx, aty, mmr ? length - 18 : 0);
...
inline void JBIG2Stream::mmrAddPixels(int a1, int blackPixels, int *codingLine, int *a0i, int w) {
    if(a1 > codingLine[*a0i]) {
        if(a1 > w) {
            error(errSyntaxError, getPos(), "JBIG2 MMR row is wrong length ({0:d})", a1);
            a1 = w;
        }
    ...
    if(mmr) {
            ...
            while(codingLine[a0i] < w) {
                ...
                switch(code1) {
                    ...
                    case EOF:
                        ...
                        break;
                    default:
                        error(errSyntaxError, getPos(), "Illegal code in JBIG2 MMR bitmap data");
                        mmrAddPixels(w, 0, codingLine, &a0i, w);
                        break;
                }
            }
        ...
        if(mmrDataLength >= 0) {
            ...
            if(mmrDecoder->get24Bits() != 0x001001) {
                error(errSyntaxError, getPos(), "Missing EOFB in JBIG2 MMR bitmap data");
            }
        }
        ...
        for(y = 0; y < h; ++y) {
            ...
            switch(templ) {
                case 0:
                    ...
                    if(atx[0] >= -8 && atx[0] <= 8 && atx[1] >= -8 && atx[1] <= 8 && atx[2] >= -8 &&
                       atx[2] <= 8 && atx[3] >= -8 && atx[3] <= 8) {
                        ...
                        for(x0 = 0, x = 0; x0 < w; x0 += 8, ++pp) {
                            ...
                            for(x1 = 0, mask = 0x80; x1 < 8 && x < w; ++x1, ++x, mask = (Guchar)(mask >> 1)) {
                                ...
                                cx = (cx0 << 13) | (cx1 << 8) | (cx2 << 4) |
                                     (((atBuf0 >> atShift0) & 1) << 3) | (((atBuf1 >> atShift1) & 1) << 2) |
                                     (((atBuf2 >> atShift2) & 1) << 1) | ((atBuf3 >> atShift3) & 1);
...
void JBIG2Stream::readGenericRefinementRegionSeg(Guint segNum, GBool imm, GBool lossless, Guint length, Guint *refSegs, Guint nRefSegs) {
    ...
    if(w == 0 || h == 0) {
        error(errSyntaxError, getPos(), "Bad size in JBIG2 generic refinement region segment");
        return;
    }
    extCombOp = segInfoFlags & 7;
    ...
    if(nRefSegs > 1) {
        error(errSyntaxError, getPos(), "Bad reference in JBIG2 generic refinement segment");
        return;
    }
    if(nRefSegs == 1) {
        if(!(seg = findSegment(refSegs[0])) || seg->getType() != jbig2SegBitmap) {
            error(errSyntaxError, getPos(), "Bad bitmap reference in JBIG2 generic refinement segment");
            return;
        }
        ...
        if(templ) {
            ...
            for(x = 0; x < w; ++x) {
                ...
                cx = (cx0 << 7) | (bitmap->nextPixel(&cxPtr1) << 6) |
                     (refBitmap->nextPixel(&cxPtr2) << 5) | (cx3 << 2) | cx4;
            ...
            for(x = 0; x < w; ++x) {
                ...
                // build the context
                cx = (cx0 << 11) | (bitmap->nextPixel(&cxPtr1) << 10) | (cx2 << 8) | (cx3 << 5) |
                     (cx4 << 2) | (bitmap->nextPixel(&cxPtr5) << 1) | refBitmap->nextPixel(&cxPtr6);
...
void JBIG2Stream::readPageInfoSeg(Guint length) {
    ...
    if(!readULong(&pageW) || !readULong(&pageH) || !readULong(&xRes) || !readULong(&yRes) ||
...
void JBIG2Stream::readCodeTableSeg(Guint segNum, Guint length) {
    ...
    huffDecoder->reset();
    huffTabSize = 8;
    huffTab = (JBIG2HuffmanTable *)gmallocn(huffTabSize, sizeof(JBIG2HuffmanTable));
    i = 0;
    val = lowVal;
    while(val < highVal) {
        if(i == huffTabSize) {
            huffTabSize *= 2;
            huffTab = (JBIG2HuffmanTable *)greallocn(huffTab, huffTabSize, sizeof(JBIG2HuffmanTable));
        }
        huffTab[i].val = val;
...
void JBIG2Stream::resetGenericStats(Guint templ, JArithmeticDecoderStats *prevStats) {
    int size;
...
void JBIG2Stream::resetRefinementStats(Guint templ, JArithmeticDecoderStats *prevStats) {
    int size;
