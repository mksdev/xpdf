...
GBool getUTF8(GString *s, int *i, Unicode *u) {
    ...
    if(c0 < 0x80) {
        *u = (Unicode)c0;
        ...
        if(*i < s->getLength() && ((c1 = (Guchar)s->getChar(*i)) & 0xc0) == 0x80) {
            *i += 1;
        ...
        if(*i < s->getLength() - 1 && ((c1 = (Guchar)s->getChar(*i)) & 0xc0) == 0x80 &&
        ...
        if(*i < s->getLength() - 2 && ((c1 = (Guchar)s->getChar(*i)) & 0xc0) == 0x80 &&
           ((c2 = (Guchar)s->getChar(*i + 1)) & 0xc0) == 0x80 &&
        ...
        if(*i < s->getLength() - 3 && ((c1 = (Guchar)s->getChar(*i)) & 0xc0) == 0x80 &&
           ((c2 = (Guchar)s->getChar(*i + 1)) & 0xc0) == 0x80 &&
           ((c3 = (Guchar)s->getChar(*i + 2)) & 0xc0) == 0x80 &&
           ((c4 = (Guchar)s->getChar(*i + 3)) & 0xc0) == 0x80) {
            *i += 4;
            *u = (Unicode)(((c0 & 0x03) << 24) | ((c1 & 0x3f) << 18) | ((c2 & 0x3f) << 12) |
                           ((c3 & 0x3f) << 6) | (c4 & 0x3f));
        } else {
            *u = (Unicode)c0;
        }
    } else if(c0 < 0xfe) {
        if(*i < s->getLength() - 4 && ((c1 = (Guchar)s->getChar(*i)) & 0xc0) == 0x80 &&
           ((c2 = (Guchar)s->getChar(*i + 1)) & 0xc0) == 0x80 &&
           ((c3 = (Guchar)s->getChar(*i + 2)) & 0xc0) == 0x80 &&
           ((c4 = (Guchar)s->getChar(*i + 3)) & 0xc0) == 0x80 &&
           ((c5 = (Guchar)s->getChar(*i + 4)) & 0xc0) == 0x80) {
            *i += 5;
            *u = (Unicode)(((c0 & 0x01) << 30) | ((c1 & 0x3f) << 24) | ((c2 & 0x3f) << 18) |
