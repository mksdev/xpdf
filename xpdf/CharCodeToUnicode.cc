...
CharCodeToUnicode *CharCodeToUnicode::parseCIDToUnicode(GString *fileName, GString *collection) {
    ...
    ctu = new CharCodeToUnicode(collection->copy(), mapA, mapLenA, gTrue, NULL, 0, 0);
    gfree(mapA);
    return ctu;
}
    ...
    while(pst->getToken(tok2, sizeof(tok2), &n2)) {
        if(!strcmp(tok2, "usecmap")) {
            ...
            while(pst->getToken(tok1, sizeof(tok1), &n1)) {
                ...
                if(!pst->getToken(tok2, sizeof(tok2), &n2) || !strcmp(tok2, "endbfrange") ||
                   !pst->getToken(tok3, sizeof(tok3), &n3) || !strcmp(tok3, "endbfrange")) {
            ...
            while(pst->getToken(tok1, sizeof(tok1), &n1)) {
                ...
                if(!pst->getToken(tok2, sizeof(tok2), &n2) || !strcmp(tok2, "endcidrange") ||
                   !pst->getToken(tok3, sizeof(tok3), &n3) || !strcmp(tok3, "endcidrange")) {
